...
const StudentShop = ({
  ...
  const renderShopItems = () => {
    ...
    return (
      <div className="grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-3 md:gap-4">
            ...
            <div className="p-4 md:p-6 space-y-4 md:space-y-6 overflow-y-auto">
              ...
              <div>
                ...
                {studentData.ownedAvatars && studentData.ownedAvatars.length > 0 ? (
                  <div className="grid grid-cols-[repeat(auto-fill,minmax(150px,1fr))] gap-2 md:gap-3">
