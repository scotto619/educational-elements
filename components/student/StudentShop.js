            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 justify-items-center">
              {dailyAvatars.map(avatar => {
                ...
                return (
                  <div
                    key={avatar.name}
                    className={`w-40 bg-white rounded-xl shadow-sm hover:shadow-md transition-all border overflow-hidden flex flex-col ${owned ? 'border-green-400 ring-2 ring-green-100' : 'border-gray-200 hover:border-blue-400'
                      }`}
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 justify-items-center">
              {dailyPets.map(pet => {
                ...
                return (
                  <div
                    key={pet.name}
                    className={`w-40 bg-white rounded-xl shadow-sm hover:shadow-md transition-all border overflow-hidden flex flex-col ${owned ? 'border-green-400 ring-2 ring-green-100' : 'border-gray-200 hover:border-purple-400'
                      }`}
                  >
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {ownedAvatars.length > 0 ? (
              <div className="grid grid-cols-[repeat(auto-fill,minmax(170px,1fr))] gap-3 justify-items-center">
            ...
            <div className="p-4 md:p-6 space-y-4 md:space-y-6 overflow-y-auto">
              ...
              <div>
                ...
                {studentData.ownedAvatars && studentData.ownedAvatars.length > 0 ? (
                  <div className="grid grid-cols-[repeat(auto-fill,minmax(160px,1fr))] gap-2 md:gap-3 justify-items-center">
