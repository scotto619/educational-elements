                ...
                <div className="flex flex-wrap gap-3">
                  {activeList.words.map(word => (
                    <div
                      ...
                      className="group flex items-center gap-3 px-4 py-2 rounded-full bg-slate-100 text-slate-700 cursor-pointer hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-300"
                      title="Click to explore this word"
                    >
