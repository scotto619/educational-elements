...
const WORD_PAIRS = [
  ...
  { realWord: 'Popcorn', imposterWord: 'Pretzels', category: 'Food' },
  { realWord: 'Donut', imposterWord: 'Bagel', category: 'Food' },
  { realWord: 'Lemonade', imposterWord: 'Orange Juice', category: 'Food' },
  { realWord: 'Apple', imposterWord: 'Pear', category: 'Food' },
  { realWord: 'Strawberry', imposterWord: 'Raspberry', category: 'Food' },
  { realWord: 'Watermelon', imposterWord: 'Rockmelon', category: 'Food' },
  { realWord: 'Pineapple', imposterWord: 'Mango', category: 'Food' },
  { realWord: 'Banana', imposterWord: 'Kiwi Fruit', category: 'Food' },
  { realWord: 'Grapes', imposterWord: 'Cherries', category: 'Food' },
  { realWord: 'Cheese', imposterWord: 'Butter', category: 'Food' },
  { realWord: 'Yoghurt', imposterWord: 'Custard', category: 'Food' },
  { realWord: 'Milkshake', imposterWord: 'Smoothie', category: 'Food' },
  { realWord: 'Cereal', imposterWord: 'Porridge', category: 'Food' },
  { realWord: 'Toast', imposterWord: 'Crumpet', category: 'Food' },
  { realWord: 'Honey', imposterWord: 'Jam', category: 'Food' },
  { realWord: 'Meat Pie', imposterWord: 'Sausage Roll', category: 'Food' },
  { realWord: 'Chicken Nuggets', imposterWord: 'Fish Fingers', category: 'Food' },
  { realWord: 'Spaghetti', imposterWord: 'Macaroni', category: 'Food' },
  { realWord: 'Rice', imposterWord: 'Couscous', category: 'Food' },
  { realWord: 'Soup', imposterWord: 'Stew', category: 'Food' },
  { realWord: 'Salad', imposterWord: 'Coleslaw', category: 'Food' },
  { realWord: 'Cookie', imposterWord: 'Brownie', category: 'Food' },
  { realWord: 'Cupcake', imposterWord: 'Lamington', category: 'Food' },
  { realWord: 'Pavlova', imposterWord: 'Cheesecake', category: 'Food' },
  { realWord: 'Fairy Bread', imposterWord: 'Jelly Cups', category: 'Food' },
  { realWord: 'Lollipop', imposterWord: 'Gummy Bears', category: 'Food' },
  { realWord: 'Marshmallow', imposterWord: 'Fudge', category: 'Food' },
  { realWord: 'Slushie', imposterWord: 'Icy Pole', category: 'Food' },
  { realWord: 'Hot Chocolate', imposterWord: 'Babycino', category: 'Food' },
  { realWord: 'Corn', imposterWord: 'Peas', category: 'Food' },
  { realWord: 'Pumpkin', imposterWord: 'Potato', category: 'Food' },
  { realWord: 'Carrot', imposterWord: 'Celery', category: 'Food' },
  { realWord: 'Broccoli', imposterWord: 'Cauliflower', category: 'Food' },
  { realWord: 'Scrambled Eggs', imposterWord: 'Omelette', category: 'Food' },
  { realWord: 'Bacon', imposterWord: 'Ham', category: 'Food' },
  { realWord: 'Sausage', imposterWord: 'Meatball', category: 'Food' },
  { realWord: 'Dumplings', imposterWord: 'Spring Rolls', category: 'Food' },
  { realWord: 'Nachos', imposterWord: 'Quesadilla', category: 'Food' },
  { realWord: 'Kebab', imposterWord: 'Falafel', category: 'Food' },
  ...
  { realWord: 'Kangaroo', imposterWord: 'Wallaby', category: 'Animals' },
  { realWord: 'Koala', imposterWord: 'Wombat', category: 'Animals' },
  { realWord: 'Emu', imposterWord: 'Ostrich', category: 'Animals' },
  { realWord: 'Platypus', imposterWord: 'Echidna', category: 'Animals' },
  { realWord: 'Crocodile', imposterWord: 'Alligator', category: 'Animals' },
  { realWord: 'Turtle', imposterWord: 'Tortoise', category: 'Animals' },
  { realWord: 'Frog', imposterWord: 'Toad', category: 'Animals' },
  { realWord: 'Rabbit', imposterWord: 'Hare', category: 'Animals' },
  { realWord: 'Mouse', imposterWord: 'Rat', category: 'Animals' },
  { realWord: 'Squirrel', imposterWord: 'Chipmunk', category: 'Animals' },
  { realWord: 'Monkey', imposterWord: 'Gorilla', category: 'Animals' },
  { realWord: 'Cheetah', imposterWord: 'Leopard', category: 'Animals' },
  { realWord: 'Zebra', imposterWord: 'Giraffe', category: 'Animals' },
  { realWord: 'Hippo', imposterWord: 'Buffalo', category: 'Animals' },
  { realWord: 'Deer', imposterWord: 'Moose', category: 'Animals' },
  { realWord: 'Owl', imposterWord: 'Bat', category: 'Animals' },
  { realWord: 'Crow', imposterWord: 'Magpie', category: 'Animals' },
  { realWord: 'Kookaburra', imposterWord: 'Cockatoo', category: 'Animals' },
  { realWord: 'Budgie', imposterWord: 'Canary', category: 'Animals' },
  { realWord: 'Chicken', imposterWord: 'Duck', category: 'Animals' },
  { realWord: 'Goat', imposterWord: 'Sheep', category: 'Animals' },
  { realWord: 'Cow', imposterWord: 'Alpaca', category: 'Animals' },
  { realWord: 'Pig', imposterWord: 'Boar', category: 'Animals' },
  { realWord: 'Hamster', imposterWord: 'Guinea Pig', category: 'Animals' },
  { realWord: 'Spider', imposterWord: 'Scorpion', category: 'Animals' },
  { realWord: 'Bee', imposterWord: 'Wasp', category: 'Animals' },
  { realWord: 'Ant', imposterWord: 'Termite', category: 'Animals' },
  { realWord: 'Caterpillar', imposterWord: 'Worm', category: 'Animals' },
  { realWord: 'Ladybug', imposterWord: 'Beetle', category: 'Animals' },
  { realWord: 'Dragonfly', imposterWord: 'Moth', category: 'Animals' },
  { realWord: 'Goldfish', imposterWord: 'Guppy', category: 'Animals' },
  ...
  { realWord: 'Golf', imposterWord: 'Mini Golf', category: 'Sports' },
  { realWord: 'Hockey', imposterWord: 'Lacrosse', category: 'Sports' },
  { realWord: 'Volleyball', imposterWord: 'Dodgeball', category: 'Sports' },
  { realWord: 'Soccer', imposterWord: 'Futsal', category: 'Sports' },
  { realWord: 'Gymnastics', imposterWord: 'Cheerleading', category: 'Sports' },
  { realWord: 'Karate', imposterWord: 'Judo', category: 'Sports' },
  { realWord: 'Fencing', imposterWord: 'Archery', category: 'Sports' },
  { realWord: 'Bowling', imposterWord: 'Lawn Bowls', category: 'Sports' },
  { realWord: 'Darts', imposterWord: 'Billiards', category: 'Sports' },
  { realWord: 'Table Tennis', imposterWord: 'Pickleball', category: 'Sports' },
  { realWord: 'Rock Climbing', imposterWord: 'Abseiling', category: 'Sports' },
  { realWord: 'Ice Skating', imposterWord: 'Rollerblading', category: 'Sports' },
  { realWord: 'Trampolining', imposterWord: 'Parkour', category: 'Sports' },
  { realWord: 'High Jump', imposterWord: 'Long Jump', category: 'Sports' },
  { realWord: 'Javelin', imposterWord: 'Discus', category: 'Sports' },
  { realWord: 'Handball', imposterWord: 'Foursquare', category: 'Sports' },
  { realWord: 'Cross Country', imposterWord: 'Relay Race', category: 'Sports' },
  { realWord: 'Water Polo', imposterWord: 'Synchronised Swimming', category: 'Sports' },
  { realWord: 'Sailing', imposterWord: 'Kayaking', category: 'Sports' },
  { realWord: 'Horse Riding', imposterWord: 'Polo', category: 'Sports' },
  { realWord: 'Marathon', imposterWord: 'Triathlon', category: 'Sports' },
  ...
  { realWord: 'Playground', imposterWord: 'Park', category: 'Places' },
  { realWord: 'Zoo', imposterWord: 'Aquarium', category: 'Places' },
  { realWord: 'Farm', imposterWord: 'Orchard', category: 'Places' },
  { realWord: 'Desert', imposterWord: 'Outback', category: 'Places' },
  { realWord: 'City', imposterWord: 'Town', category: 'Places' },
  { realWord: 'Bridge', imposterWord: 'Tunnel', category: 'Places' },
  { realWord: 'Lighthouse', imposterWord: 'Windmill', category: 'Places' },
  { realWord: 'Cave', imposterWord: 'Canyon', category: 'Places' },
  { realWord: 'Supermarket', imposterWord: 'Bakery', category: 'Places' },
  { realWord: 'Cinema', imposterWord: 'Theatre', category: 'Places' },
  { realWord: 'Restaurant', imposterWord: 'Cafe', category: 'Places' },
  { realWord: 'Hotel', imposterWord: 'Motel', category: 'Places' },
  { realWord: 'Campsite', imposterWord: 'Cabin', category: 'Places' },
  { realWord: 'Swimming Pool', imposterWord: 'Water Park', category: 'Places' },
  { realWord: 'Theme Park', imposterWord: 'Circus', category: 'Places' },
  { realWord: 'Skate Park', imposterWord: 'BMX Track', category: 'Places' },
  { realWord: 'Post Office', imposterWord: 'Bank', category: 'Places' },
  { realWord: 'Fire Station', imposterWord: 'Police Station', category: 'Places' },
  { realWord: 'Harbour', imposterWord: 'Marina', category: 'Places' },
  { realWord: 'Pyramid', imposterWord: 'Temple', category: 'Places' },
  { realWord: 'Igloo', imposterWord: 'Treehouse', category: 'Places' },
  ...
  { realWord: 'Flute', imposterWord: 'Recorder', category: 'Music' },
  { realWord: 'Clarinet', imposterWord: 'Saxophone', category: 'Music' },
  { realWord: 'Cello', imposterWord: 'Double Bass', category: 'Music' },
  { realWord: 'Ukulele', imposterWord: 'Banjo', category: 'Music' },
  { realWord: 'Harmonica', imposterWord: 'Accordion', category: 'Music' },
  { realWord: 'Xylophone', imposterWord: 'Glockenspiel', category: 'Music' },
  { realWord: 'Tambourine', imposterWord: 'Maracas', category: 'Music' },
  { realWord: 'Triangle', imposterWord: 'Cowbell', category: 'Music' },
  { realWord: 'Bagpipes', imposterWord: 'Didgeridoo', category: 'Music' },
  { realWord: 'Choir', imposterWord: 'Band', category: 'Music' },
  { realWord: 'Concert', imposterWord: 'Festival', category: 'Music' },
  { realWord: 'Opera', imposterWord: 'Musical', category: 'Music' },
  { realWord: 'Rapper', imposterWord: 'Singer', category: 'Music' },
  { realWord: 'Orchestra', imposterWord: 'Jazz Band', category: 'Music' },
  ...
  { realWord: 'Cloud', imposterWord: 'Fog', category: 'Nature' },
  { realWord: 'Rain', imposterWord: 'Hail', category: 'Nature' },
  { realWord: 'Snow', imposterWord: 'Frost', category: 'Nature' },
  { realWord: 'Earthquake', imposterWord: 'Landslide', category: 'Nature' },
  { realWord: 'Cactus', imposterWord: 'Tumbleweed', category: 'Nature' },
  { realWord: 'Sunflower', imposterWord: 'Daisy', category: 'Nature' },
  { realWord: 'Rose', imposterWord: 'Tulip', category: 'Nature' },
  { realWord: 'Oak Tree', imposterWord: 'Palm Tree', category: 'Nature' },
  { realWord: 'Mushroom', imposterWord: 'Moss', category: 'Nature' },
  { realWord: 'Pebble', imposterWord: 'Boulder', category: 'Nature' },
  { realWord: 'Sand Dune', imposterWord: 'Cliff', category: 'Nature' },
  { realWord: 'Meadow', imposterWord: 'Swamp', category: 'Nature' },
  { realWord: 'Blizzard', imposterWord: 'Heatwave', category: 'Nature' },
  { realWord: 'Puddle', imposterWord: 'Pond', category: 'Nature' },
  ...
  { realWord: 'Mars', imposterWord: 'Venus', category: 'Space' },
  { realWord: 'Rocket', imposterWord: 'Space Shuttle', category: 'Space' },
  { realWord: 'Alien', imposterWord: 'UFO', category: 'Space' },
  { realWord: 'Space Station', imposterWord: 'Lunar Base', category: 'Space' },
  { realWord: 'Galaxy', imposterWord: 'Universe', category: 'Space' },
  { realWord: 'Constellation', imposterWord: 'Shooting Star', category: 'Space' },
  { realWord: 'Gravity', imposterWord: 'Orbit', category: 'Space' },
  { realWord: 'Mercury', imposterWord: 'Neptune', category: 'Space' },
  { realWord: 'Pluto', imposterWord: 'Uranus', category: 'Space' },
  { realWord: 'Milky Way', imposterWord: 'Andromeda', category: 'Space' },
  { realWord: 'Solar Eclipse', imposterWord: 'Supermoon', category: 'Space' },
  { realWord: 'Mars Rover', imposterWord: 'Moon Buggy', category: 'Space' },
  ...
  { realWord: 'Eraser', imposterWord: 'Sharpener', category: 'School' },
  { realWord: 'Scissors', imposterWord: 'Glue Stick', category: 'School' },
  { realWord: 'Crayons', imposterWord: 'Markers', category: 'School' },
  { realWord: 'Paint', imposterWord: 'Chalk', category: 'School' },
  { realWord: 'Homework', imposterWord: 'Spelling Test', category: 'School' },
  { realWord: 'Excursion', imposterWord: 'Assembly', category: 'School' },
  { realWord: 'Textbook', imposterWord: 'Dictionary', category: 'School' },
  { realWord: 'Notebook', imposterWord: 'Diary', category: 'School' },
  { realWord: 'Desk', imposterWord: 'Locker', category: 'School' },
  { realWord: 'Recess', imposterWord: 'Lunchtime', category: 'School' },
  { realWord: 'Principal', imposterWord: 'Teacher', category: 'School' },
  { realWord: 'School Uniform', imposterWord: 'Sports Kit', category: 'School' },
  { realWord: 'Report Card', imposterWord: 'Certificate', category: 'School' },
  { realWord: 'Classroom', imposterWord: 'Staff Room', category: 'School' },
  ...
  { realWord: 'Elf', imposterWord: 'Fairy', category: 'Fantasy' },
  { realWord: 'Goblin', imposterWord: 'Troll', category: 'Fantasy' },
  { realWord: 'Giant', imposterWord: 'Ogre', category: 'Fantasy' },
  { realWord: 'Ghost', imposterWord: 'Zombie', category: 'Fantasy' },
  { realWord: 'Genie', imposterWord: 'Leprechaun', category: 'Fantasy' },
  { realWord: 'Magic Wand', imposterWord: 'Spell Book', category: 'Fantasy' },
  { realWord: 'Potion', imposterWord: 'Elixir', category: 'Fantasy' },
  { realWord: 'Treasure', imposterWord: 'Crown', category: 'Fantasy' },
  { realWord: 'Sword', imposterWord: 'Shield', category: 'Fantasy' },
  { realWord: 'Dungeon', imposterWord: 'Tower', category: 'Fantasy' },
  { realWord: 'Superhero', imposterWord: 'Villain', category: 'Fantasy' },
  { realWord: 'Griffin', imposterWord: 'Centaur', category: 'Fantasy' },
  { realWord: 'Yeti', imposterWord: 'Bigfoot', category: 'Fantasy' },

  // ── Movies & TV ──
  { realWord: 'Actor', imposterWord: 'Director', category: 'Movies & TV' },
  { realWord: 'Cartoon', imposterWord: 'Anime', category: 'Movies & TV' },
  { realWord: 'Comedy', imposterWord: 'Drama', category: 'Movies & TV' },
  { realWord: 'Trailer', imposterWord: 'Sequel', category: 'Movies & TV' },
  { realWord: 'Documentary', imposterWord: 'News Report', category: 'Movies & TV' },
  { realWord: 'Game Show', imposterWord: 'Talent Show', category: 'Movies & TV' },
  { realWord: 'Animation', imposterWord: 'Claymation', category: 'Movies & TV' },
  { realWord: 'Movie Star', imposterWord: 'Pop Star', category: 'Movies & TV' },
  { realWord: 'Red Carpet', imposterWord: 'Awards Night', category: 'Movies & TV' },
  { realWord: 'Subtitles', imposterWord: 'Credits', category: 'Movies & TV' },
  { realWord: 'Cooking Show', imposterWord: 'Renovation Show', category: 'Movies & TV' },
  { realWord: 'Stunt Double', imposterWord: 'Extra', category: 'Movies & TV' },
  { realWord: 'Sitcom', imposterWord: 'Soap Opera', category: 'Movies & TV' },
  { realWord: 'Blockbuster', imposterWord: 'Box Office', category: 'Movies & TV' },
  { realWord: 'Screenplay', imposterWord: 'Storyboard', category: 'Movies & TV' },
  { realWord: 'Season Finale', imposterWord: 'Pilot Episode', category: 'Movies & TV' },

  // ── Jobs ──
  { realWord: 'Doctor', imposterWord: 'Nurse', category: 'Jobs' },
  { realWord: 'Firefighter', imposterWord: 'Paramedic', category: 'Jobs' },
  { realWord: 'Police Officer', imposterWord: 'Security Guard', category: 'Jobs' },
  { realWord: 'Chef', imposterWord: 'Baker', category: 'Jobs' },
  { realWord: 'Farmer', imposterWord: 'Gardener', category: 'Jobs' },
  { realWord: 'Pilot', imposterWord: 'Flight Attendant', category: 'Jobs' },
  { realWord: 'Vet', imposterWord: 'Zookeeper', category: 'Jobs' },
  { realWord: 'Dentist', imposterWord: 'Optometrist', category: 'Jobs' },
  { realWord: 'Builder', imposterWord: 'Plumber', category: 'Jobs' },
  { realWord: 'Electrician', imposterWord: 'Mechanic', category: 'Jobs' },
  { realWord: 'Scientist', imposterWord: 'Inventor', category: 'Jobs' },
  { realWord: 'Artist', imposterWord: 'Sculptor', category: 'Jobs' },
  { realWord: 'Author', imposterWord: 'Journalist', category: 'Jobs' },
  { realWord: 'Musician', imposterWord: 'Dancer', category: 'Jobs' },
  { realWord: 'Lifeguard', imposterWord: 'Swim Coach', category: 'Jobs' },
  { realWord: 'Hairdresser', imposterWord: 'Barber', category: 'Jobs' },
  { realWord: 'Postie', imposterWord: 'Delivery Driver', category: 'Jobs' },
  { realWord: 'Lawyer', imposterWord: 'Judge', category: 'Jobs' },
  { realWord: 'Coach', imposterWord: 'Referee', category: 'Jobs' },
  { realWord: 'Photographer', imposterWord: 'Filmmaker', category: 'Jobs' },

  // ── Ocean ──
  { realWord: 'Clownfish', imposterWord: 'Angelfish', category: 'Ocean' },
  { realWord: 'Seahorse', imposterWord: 'Starfish', category: 'Ocean' },
  { realWord: 'Crab', imposterWord: 'Lobster', category: 'Ocean' },
  { realWord: 'Stingray', imposterWord: 'Eel', category: 'Ocean' },
  { realWord: 'Coral Reef', imposterWord: 'Kelp Forest', category: 'Ocean' },
  { realWord: 'Submarine', imposterWord: 'Shipwreck', category: 'Ocean' },
  { realWord: 'Scuba Diving', imposterWord: 'Snorkelling', category: 'Ocean' },
  { realWord: 'Wave', imposterWord: 'Tide', category: 'Ocean' },
  { realWord: 'Seashell', imposterWord: 'Driftwood', category: 'Ocean' },
  { realWord: 'Anchor', imposterWord: 'Life Ring', category: 'Ocean' },
  { realWord: 'Pearl', imposterWord: 'Message in a Bottle', category: 'Ocean' },
  { realWord: 'Sea Lion', imposterWord: 'Walrus', category: 'Ocean' },
  { realWord: 'Orca', imposterWord: 'Narwhal', category: 'Ocean' },
  { realWord: 'Squid', imposterWord: 'Cuttlefish', category: 'Ocean' },
  { realWord: 'Pufferfish', imposterWord: 'Swordfish', category: 'Ocean' },
  { realWord: 'Hermit Crab', imposterWord: 'Barnacle', category: 'Ocean' },
  { realWord: 'Rockpool', imposterWord: 'Sandbar', category: 'Ocean' },
  { realWord: 'Jet Ski', imposterWord: 'Paddleboard', category: 'Ocean' },

  // ── Technology ──
  { realWord: 'Robot', imposterWord: 'Cyborg', category: 'Technology' },
  { realWord: 'Smartphone', imposterWord: 'Smartwatch', category: 'Technology' },
  { realWord: 'Video Game', imposterWord: 'Card Game', category: 'Technology' },
  { realWord: 'Console', imposterWord: 'Arcade', category: 'Technology' },
  { realWord: 'Headset', imposterWord: 'Controller', category: 'Technology' },
  { realWord: 'Website', imposterWord: 'App', category: 'Technology' },
  { realWord: 'Email', imposterWord: 'Text Message', category: 'Technology' },
  { realWord: 'Password', imposterWord: 'Username', category: 'Technology' },
  { realWord: 'WiFi', imposterWord: 'Bluetooth', category: 'Technology' },
  { realWord: 'Charger', imposterWord: 'Power Bank', category: 'Technology' },
  { realWord: 'Camera', imposterWord: 'Webcam', category: 'Technology' },
  { realWord: 'Printer', imposterWord: 'Scanner', category: 'Technology' },
  { realWord: 'Virtual Reality', imposterWord: 'Hologram', category: 'Technology' },
  { realWord: 'Coding', imposterWord: 'Typing', category: 'Technology' },
  { realWord: 'Emoji', imposterWord: 'Sticker', category: 'Technology' },
  { realWord: 'Podcast', imposterWord: 'Radio', category: 'Technology' },
  { realWord: 'Speaker', imposterWord: 'Earbuds', category: 'Technology' },
  { realWord: 'Drone', imposterWord: 'Remote Control Car', category: 'Technology' },

  // ── Transport ──
  { realWord: 'Car', imposterWord: 'Ute', category: 'Transport' },
  { realWord: 'Truck', imposterWord: 'Van', category: 'Transport' },
  { realWord: 'Bus', imposterWord: 'Tram', category: 'Transport' },
  { realWord: 'Train', imposterWord: 'Monorail', category: 'Transport' },
  { realWord: 'Bicycle', imposterWord: 'Scooter', category: 'Transport' },
  { realWord: 'Motorbike', imposterWord: 'Quad Bike', category: 'Transport' },
  { realWord: 'Helicopter', imposterWord: 'Hot Air Balloon', category: 'Transport' },
  { realWord: 'Aeroplane', imposterWord: 'Glider', category: 'Transport' },
  { realWord: 'Ferry', imposterWord: 'Cruise Ship', category: 'Transport' },
  { realWord: 'Yacht', imposterWord: 'Speedboat', category: 'Transport' },
  { realWord: 'Canoe', imposterWord: 'Raft', category: 'Transport' },
  { realWord: 'Ambulance', imposterWord: 'Fire Truck', category: 'Transport' },
  { realWord: 'Tractor', imposterWord: 'Bulldozer', category: 'Transport' },
  { realWord: 'Crane', imposterWord: 'Forklift', category: 'Transport' },
  { realWord: 'Limousine', imposterWord: 'Taxi', category: 'Transport' },
  { realWord: 'Caravan', imposterWord: 'Houseboat', category: 'Transport' },
  { realWord: 'Unicycle', imposterWord: 'Segway', category: 'Transport' },
  { realWord: 'Sled', imposterWord: 'Toboggan', category: 'Transport' },

  // ── Around the House ──
  { realWord: 'Couch', imposterWord: 'Beanbag', category: 'Around the House' },
  { realWord: 'Fridge', imposterWord: 'Freezer', category: 'Around the House' },
  { realWord: 'Microwave', imposterWord: 'Oven', category: 'Around the House' },
  { realWord: 'Kettle', imposterWord: 'Toaster', category: 'Around the House' },
  { realWord: 'Vacuum', imposterWord: 'Broom', category: 'Around the House' },
  { realWord: 'Washing Machine', imposterWord: 'Dishwasher', category: 'Around the House' },
  { realWord: 'Pillow', imposterWord: 'Blanket', category: 'Around the House' },
  { realWord: 'Bunk Bed', imposterWord: 'Hammock', category: 'Around the House' },
  { realWord: 'Mirror', imposterWord: 'Window', category: 'Around the House' },
  { realWord: 'Curtains', imposterWord: 'Blinds', category: 'Around the House' },
  { realWord: 'Lamp', imposterWord: 'Candle', category: 'Around the House' },
  { realWord: 'Clock', imposterWord: 'Calendar', category: 'Around the House' },
  { realWord: 'Bathtub', imposterWord: 'Shower', category: 'Around the House' },
  { realWord: 'Towel', imposterWord: 'Bathrobe', category: 'Around the House' },
  { realWord: 'Toothbrush', imposterWord: 'Hairbrush', category: 'Around the House' },
  { realWord: 'Garden Hose', imposterWord: 'Sprinkler', category: 'Around the House' },
  { realWord: 'Letterbox', imposterWord: 'Doorbell', category: 'Around the House' },
  { realWord: 'Garage', imposterWord: 'Shed', category: 'Around the House' },
  { realWord: 'Cubby House', imposterWord: 'Sandpit', category: 'Around the House' },
  { realWord: 'BBQ', imposterWord: 'Fire Pit', category: 'Around the House' },

  // ── Parties & Fun ──
  { realWord: 'Birthday Party', imposterWord: 'Sleepover', category: 'Parties & Fun' },
  { realWord: 'Easter Egg Hunt', imposterWord: 'Treasure Hunt', category: 'Parties & Fun' },
  { realWord: 'Halloween', imposterWord: 'Costume Party', category: 'Parties & Fun' },
  { realWord: 'Fireworks', imposterWord: 'Sparklers', category: 'Parties & Fun' },
  { realWord: 'Balloon', imposterWord: 'Streamer', category: 'Parties & Fun' },
  { realWord: 'Pinata', imposterWord: 'Party Bag', category: 'Parties & Fun' },
  { realWord: 'Camping Trip', imposterWord: 'Road Trip', category: 'Parties & Fun' },
  { realWord: 'Picnic', imposterWord: 'Beach Day', category: 'Parties & Fun' },
  { realWord: 'Board Game', imposterWord: 'Jigsaw Puzzle', category: 'Parties & Fun' },
  { realWord: 'Hide and Seek', imposterWord: 'Tag', category: 'Parties & Fun' },
  { realWord: 'Musical Chairs', imposterWord: 'Pass the Parcel', category: 'Parties & Fun' },
  { realWord: 'Magic Show', imposterWord: 'Puppet Show', category: 'Parties & Fun' },
  { realWord: 'Face Painting', imposterWord: 'Glitter Tattoo', category: 'Parties & Fun' },
  { realWord: 'Water Balloon Fight', imposterWord: 'Slip and Slide', category: 'Parties & Fun' },
  { realWord: 'Karaoke', imposterWord: 'Dance Party', category: 'Parties & Fun' },
  { realWord: 'Campfire', imposterWord: 'Torch Light', category: 'Parties & Fun' },
  { realWord: 'Christmas', imposterWord: 'New Years Eve', category: 'Parties & Fun' },
  { realWord: 'April Fools', imposterWord: 'Practical Joke', category: 'Parties & Fun' },
];

const CATEGORIES = [
  'All', 'Food', 'Animals', 'Sports', 'Places', 'Music', 'Nature', 'Space', 'School', 'Fantasy',
  'Movies & TV', 'Jobs', 'Ocean', 'Technology', 'Transport', 'Around the House', 'Parties & Fun',
];
...
const getRandomWordPair = (category = 'All', usedRealWords = []) => {
  const pool = category === 'All' ? WORD_PAIRS : WORD_PAIRS.filter(p => p.category === category);
  // Avoid repeating words already played in this room (reset once the pool is exhausted)
  const used = new Set(usedRealWords);
  const fresh = pool.filter(p => !used.has(p.realWord));
...
const WordImposterGame = ({ studentData, showToast }) => {
  ...
  const startGame = useCallback(async () => {
    ...
    const usedWords = Array.isArray(roomData.usedWords) ? roomData.usedWords : [];
    const wordPair = getRandomWordPair(selectedCategory, usedWords);
    ...
    await fb.update(fb.ref(fb.database, `wordImposterRooms/${roomCode}`), {
      ...
      usedWords: [...usedWords.slice(-100), wordPair.realWord],
    });
