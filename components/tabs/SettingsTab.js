            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                  <h4 className="font-semibold text-red-800 mb-2">📧 Request Account Deletion</h4>
                  <p className="text-sm text-red-700 mb-3">
                    Send a request to our team to delete your account. We will process your request and confirm via email.
                  </p>
                  <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 space-y-2 sm:space-y-0">
                    ...
                    <p className="text-xs text-red-600 italic">Opens your email client.</p>
                  </div>
                </div>
              </div>
            </div>
