...
const resourcesBySubject = {
  ...
  english: [
    ...
    { id: 'mythical-creatures', title: 'Comprehension — Mythical Creatures', description: '18 differentiated comprehension worksheets (9 creatures × 2 levels) for engaging reading practice', pdfPath: '/Unit Resources/English/Mythical_Creatures.pdf', icon: '🐉' },
    { id: 'text-highlighting', title: 'Comprehension — Text Highlighting', description: '6 text highlighting comprehension activities to build close-reading and annotation skills', pdfPath: '/Unit Resources/English/Text_Highlighting.pdf', icon: '🖊️' },
    { id: 'writing-cute-collection', title: 'Writing — Cute Collection', description: '6 themed writing worksheet pages with a fun, colourful design for student writing practice', pdfPath: '/Unit Resources/English/Writing_Cute_Collection.pdf', icon: '🌸' },
    { id: 'writing-templates', title: 'Writing Templates', description: 'Information and narrative note-taking, planning and writing templates to scaffold student writing', pdfPath: '/Unit Resources/English/Writing_Templates.pdf', icon: '📋' },
    { id: 'booklets', title: 'Booklets', description: '20-page collection of student booklets covering a range of English skills and activities', pdfPath: '/Unit Resources/English/Booklets.pdf', icon: '📒' },
  ...
  mathematics: [
    ...
    { id: 'fractions-lesson', title: 'Fractions Lesson', description: '13-page fractions lesson set covering concepts, worked examples and differentiated practice activities', pdfPath: '/Unit Resources/Maths/Fractions_Lesson.pdf', icon: '½' },
