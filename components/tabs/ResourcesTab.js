...
const RESOURCE_TOOLS = [
  ...
  { id: 'visual-writing-prompts', group: 'English', name: 'Writing Studio', emoji: '✍️', component: VisualWritingPrompts,
    description: 'Visual prompts with word banks, sentence starters and fullscreen presentation — plus a live inbox to read, comment on and reward the stories students write in their portal.',
    badge: 'REBUILT', badgeColor: 'bg-cyan-100 text-cyan-700', borderColor: 'border-pink-300', bgColor: 'bg-pink-50', hoverColor: 'hover:bg-pink-100' },
