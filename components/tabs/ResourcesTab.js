...
const RESOURCE_TOOLS = [
  ...
  { id: 'column-strategy', group: 'Mathematics', name: 'Column Strategy Lab', emoji: '🧱', component: ColumnStrategy,
    description: 'Interactive column addition & subtraction with whole numbers and decimals — guided carrying and borrowing, worked examples, and step-checked practice.',
