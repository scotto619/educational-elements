// components/curriculum/literacy/beginnerReaders/BeginnerLevel1Sounds.js
// LEVEL 1 - BASIC SOUND RECOGNITION
// Large font, repetitive copies of single sounds with related images

export const BEGINNER_LEVEL_1_SOUNDS = [
  {
    id: 'basic-s',
    sound: 's',
    title: 'The Sound S',
    description: 'Learning the letter S sound',
    image: '🐍', // Snake
    practices: [
      {
  ...
  },
  {
    ...
    sound: 'a',
    title: 'The Sound A',
    description: 'Learning the letter A sound',
    image: '🍎', // Apple
    practices: [
      {
        type: 'sound-recognition',
  ...
  },
  {
    ...
    sound: 't',
    title: 'The Sound T',
    description: 'Learning the letter T sound',
    image: '🌳', // Tree
    practices: [
      {
        type: 'sound-recognition',
  ...
  },
  {
    ...
    sound: 'p',
    title: 'The Sound P',
    description: 'Learning the letter P sound',
    image: '🐧', // Penguin
    practices: [
      {
        type: 'sound-recognition',
  ...
  },
  {
    ...
    sound: 'i',
    title: 'The Sound I',
    description: 'Learning the letter I sound',
    image: '🍦', // Ice cream
    practices: [
      {
        type: 'sound-recognition',
  ...
  },
  {
    ...
    sound: 'n',
    title: 'The Sound N',
    description: 'Learning the letter N sound',
    image: '🥜', // Nut
    practices: [
      {
        type: 'sound-recognition',
