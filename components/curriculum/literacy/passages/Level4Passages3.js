...
export const LEVEL_4_PASSAGES_3 = [
  // LEVEL 4.11 - WR & Consonant Clusters
  {
    id: "4.11",
    level: "Level 4.11 - WR & Consonant Clusters",
    spellingFocus: "wr beginnings and complex blends",
    targetWords: ["wring", "wreath", "writhing", "wriggle", "wrapper", "wrestle", "written", "wrinkle", "wreckage", "sword", "answer", "swordfish"],
    texts: [
      {
        type: "narrative",
        title: "The Wrestler's Wreath",
        wordCount: 149,
        content: `Tommy loved to wrestle with his older brother Jake, but today they found something more interesting than their usual matches. Hidden in the wreckage of their grandmother's attic was an old wooden box wrapped in a faded cloth wrapper.

Inside the box was a beautiful wreath made of silver wire and a mysterious written note. The paper had a wrinkle down the middle, and the words seemed to wriggle and dance before their eyes.

"I know the answer to this riddle," Jake said, reading the written clues carefully. The note mentioned a sword hidden somewhere in the house, possibly near something that looked like a swordfish.
...
Behind the swordfish, they discovered the answer to the riddle: a small ceremonial sword that had belonged to their great-grandfather. The written instructions explained that the sword and wreath were family treasures, wrapped in mystery but meant to be found by curious grandchildren.`,
      ...
      {
        type: "informational",
        title: "Wrestling Through History",
        wordCount: 151,
        content: `Wrestling is one of the world's oldest sports, with written records dating back thousands of years. Ancient civilizations would wring garlands into wreaths to honor their greatest wrestling champions.

Historical wreckage from ancient Olympics shows that wrestlers often carried ceremonial swords as symbols of their warrior status. These weapons weren't meant for fighting, but as answers to questions about courage and strength.

The sport requires athletes to wriggle free from holds while trying to wrestle their opponents to the ground. A wrestler's uniform, called a singlet, wraps around the body without creating wrinkles that opponents could grab.

Many cultures have written traditions about wrestling, including stories of heroes who could wrestle sea monsters or legendary swordfish. These tales weren't meant as literal truth, but as symbolic answers to questions about human potential.
...
Written rules now govern the sport, preventing the wreckage of unfair competition.`,
      ...
      },
      {
        ...
        wordCount: 148,
        content: `Don't let modern technology wring the traditional skills from your education! Learning to make things with your hands, like weaving a wreath or forging a ceremonial sword, connects you to thousands of years of human knowledge.

Many students think written instructions for traditional crafts are outdated, but these skills provide answers to important questions about creativity and problem-solving. When you wrestle with a difficult craft project, you learn persistence that helps with every challenge.

Schools often treat traditional skills like wreckage from the past, but this attitude creates wrinkles in comprehensive education. Learning to wrap gifts beautifully, wriggle through complex craft steps, or even practice simple wrestling moves teaches valuable lessons.
...
Don't let traditional knowledge become wreckage of forgotten wisdom. Whether you're interested in making wreaths, learning swordplay, or any other traditional skill, these activities provide written proof of human ingenuity and creativity.`,
      ...
      },
      {
        ...
        wordCount: 147,
        content: `I wring the cloth around my hands,
And wrestle with what life demands.
The written words of long ago
Still teach us what we need to know.

A wreath of flowers, bright and new,
Can wrap around both me and you.
Through wreckage of the passing years,
Traditional wisdom still appears.

The sword and swordfish, side by side,
Show answers we cannot hide.
When modern life makes spirits writhe,
Old skills help us stay alive.

Don't wriggle free from what you've learned,
These treasures must be always earned.
The wrapper holds the precious gift
Of knowledge that will help you lift.

Each wrinkle in the ancient page
Connects us to another age.
The answer lies in learning how
To honor past and present now.
...
Will wring the best that's found in you.`,
  ...
  // LEVEL 4.12 - UN- Prefix
  {
    id: "4.12",
    level: "Level 4.12 - UN- Prefix",
    spellingFocus: "un- prefix patterns",
    targetWords: ["unsuitable", "unusual", "unselfish", "unstable", "unfortunate", "undecided", "unoccupied", "undesirable", "unpleasant", "uncertain", "unpopular", "unequal"],
    texts: [
      {
        type: "narrative",
        title: "The Unusual Pet Store",
        wordCount: 152,
        content: `Maya was undecided about what kind of pet would be suitable for her unusual family situation. Her apartment was small and unoccupied most of the day, making traditional pets unsuitable for their lifestyle.

At the pet store, she met Mr. Chen, an unselfish owner who refused to sell pets to uncertain customers. "It would be unfortunate if we placed animals in unsuitable homes," he explained kindly.

Maya found the selection unusual but wonderful. Instead of offering unpopular or undesirable animals, Mr. Chen specialized in pets that were suitable for unoccupied homes during the day.

"These hermit crabs are quite stable and don't require unequal amounts of attention," he said, showing her an aquarium. "They're not unpleasant to care for, and they're perfect for uncertain schedules."
...
"It's never unfortunate to take time making important decisions," Mr. Chen smiled. "Come back when you're more certain, and we'll find the perfect unusual pet for your unique situation."`,
      ...
      },
      {
        ...
        wordCount: 149,
        content: `Making good decisions requires avoiding unsuitable choices that might lead to unfortunate consequences. When you're undecided about important matters, it's unwise to rush into unstable situations.

Being uncertain about a decision isn't necessarily undesirable. It's actually unselfish to take time considering how your choices might affect others. Many people make unsuccessful decisions because they're unprepared for unequal outcomes.

Students often feel unequal pressure to make decisions quickly, but this approach is usually unstable and can lead to unpleasant results. It's unsuitable to let others make you feel unpopular for being thoughtful and uncertain.

Sometimes the most unselfish thing you can do is admit when you're undecided. This prevents unfortunate mistakes that could create unoccupied opportunities or undesirable situations for everyone involved.
...
The most unfortunate decisions often come from trying to appear certain when you're actually undecided about unsuitable options.`,
      ...
      },
      {
        ...
        wordCount: 150,
        content: `Don't let peer pressure make you feel unpopular for being uncertain about unsuitable choices! Taking time to think prevents unfortunate decisions that could lead to unpleasant consequences.

Many students feel unequal pressure to appear decided about everything, but this unstable approach often leads to undesirable outcomes. It's actually unselfish to admit when you're undecided rather than making unsuitable commitments.

Being uncertain doesn't make you unpopular or undesirable as a friend. Smart people know it's unfortunate to rush into unstable situations just to appear confident. The most successful students are those who avoid unequal decision-making.

Don't let others convince you that being undecided is unsuitable or unpleasant. Some decisions require careful thought, and it's unwise to let unoccupied time pressure you into unfortunate choices.
...
Being uncertain shows wisdom, not weakness. Don't let unsuitable pressure from others lead you toward unfortunate decisions that could create unpleasant situations for everyone involved.`,
      ...
      {
        type: "poetry",
        title: "Taking Time to Choose",
        wordCount: 148,
        content: `When choices seem unsuitable,
And outcomes look unstable,
It's fine to be uncertain,
Behind life's changing curtain.

Don't let others think you're weak
For being slow to speak.
Though undecided you may be,
That shows maturity.

An unselfish heart will wait
To choose the proper fate.
Unfortunate are those who rush
Through life's decisions in a crush.

Unequal pressure from your peers
Can fill your heart with fears.
But undesirable choices made in haste
Will surely go to waste.

So when you're feeling quite unsure,
Remember this for sure:
It's never unpleasant to take time
To make your choices truly shine.
...
Thoughtful decisions bring no shame.`,
  ...
  // LEVEL 4.13 - OR Agent Endings
  {
    id: "4.13",
    level: "Level 4.13 - OR Agent Endings",
    spellingFocus: "or suffix for people who do things",
    targetWords: ["editor", "instigator", "competitor", "instructor", "successor", "predecessor", "collector", "debtor", "processor", "inspector", "supervisor", "exhibitor"],
    texts: [
      {
        type: "narrative",
        title: "The Museum Exhibit Adventure",
        wordCount: 153,
        content: `Emma's class visited the natural history museum where they met Dr. Sarah, an inspector who worked as both an editor of scientific journals and a collector of rare fossils.

"Every exhibitor in our museum was once a student like you," Dr. Sarah explained as she showed them around. "I started as a competitor in science fairs before becoming an instructor's assistant."

The students learned that Dr. Sarah's predecessor had been a famous debtor who spent all his money collecting specimens. Her supervisor encouraged her to become the successor to his work, but in a more responsible way.

"As a processor of new discoveries and an instigator of research projects, I help decide which exhibits visitors will see," she continued. Emma was fascinated by how one person could be both a collector of ancient artifacts and an editor of modern research.
...
Emma left the museum determined to be the successor to her own dreams.`,
      ...
      {
        type: "informational",
        title: "Career Paths in Science",
        wordCount: 148,
        content: `Science careers offer many opportunities to become an editor, collector, inspector, or processor of important information. Each scientist serves as both a competitor for new discoveries and an instructor for future generations.

A museum curator acts as an exhibitor of scientific knowledge while serving as a supervisor for research projects. Their predecessor might have been a collector of specimens, while their successor could become an instigator of new scientific programs.

Laboratory work requires an inspector's attention to detail and a processor's ability to handle complex data. Many scientists also serve as an editor for research publications, helping their colleagues share discoveries with the world.
...
The best scientists understand that being a competitor in research means collaborating with others, not working against them. Every successful researcher serves as both a predecessor for future scientists and a successor to earlier discoveries.`,
      ...
      {
        type: "persuasive",
        title: "Develop Multiple Skills",
        wordCount: 151,
        content: `Don't limit yourself to being just one type of person – become a collector of diverse skills that will make you a strong competitor in any field! Whether you want to be an editor, instructor, inspector, or supervisor, success requires multiple abilities.

Many students think they should focus on becoming a specialist, but the most successful people serve as both an exhibitor of their main talents and a processor of information from many different areas.

Your teacher isn't just an instructor – they're also an editor of lesson plans, a collector of teaching materials, and an inspector of student progress. Like their predecessor, they understand that being a supervisor requires skills from many different areas.
...
Being a competitor doesn't mean beating others – it means being the best version of yourself. Whether you become a debtor paying for education or an exhibitor of your talents, remember that every inspector of quality work appreciates diverse abilities in the people they supervise.`,
      ...
      {
        type: "poetry",
        title: "Many Roles to Play",
        wordCount: 149,
        content: `The editor sits with careful eye,
While the collector counts each prize.
An inspector checks what others miss,
A processor handles lists like this.

The instructor teaches every day,
While the supervisor leads the way.
A competitor runs the longest race,
An exhibitor shows with pride and grace.

Each predecessor paved the road
For the successor's lighter load.
The instigator starts things new,
While the debtor pays what's due.

From collector of the finest art
To editor with the kindest heart,
Each role we play throughout our life
Helps cut through trouble like a knife.

So be an inspector of your dreams,
A processor of your grandest schemes.
Like every supervisor knows,
Success is where hard work goes.
...
About the best that lives in you.`,
  ...
  // LEVEL 4.14 - Homophones Advanced
  {
    id: "4.14",
    level: "Level 4.14 - Homophones Advanced",
    spellingFocus: "Advanced homophones",
    targetWords: ["become", "outcome", "someday", "welcome", "flood", "blood", "wolf", "woman", "scone", "shone", "bygone", "knowledge"],
    texts: [
      {
        type: "narrative",
        title: "The Welcome Storm",
        wordCount: 154,
        content: `Grandma Wilson was a wise woman whose knowledge of weather patterns helped the whole village prepare for storms. Someday, she hoped to become the official weather predictor, but for now, her neighbors welcome her warnings about dangerous floods.

One morning, the sun shone brightly on the distant mountains, but Grandma's blood pressure rose as she studied the clouds. "The outcome of this weather will bring a flood," she predicted, sharing her knowledge with anyone who would listen.

The villagers had become accustomed to her accurate predictions. Unlike the bygone days when people ignored weather warnings, everyone now trusted the woman whose knowledge had saved them before.

As the day progressed, dark clouds began to gather, and the wind howled like a hungry wolf. Grandma served tea and fresh scones to neighbors who had come seeking shelter in her sturdy house.
...
Someday, other villages would welcome Grandma's wisdom, but for now, her knowledge belonged to the people who had learned to trust her completely.`,
      ...
      },
      {
        ...
        wordCount: 150,
        content: `Weather prediction has become much more accurate since the bygone era when people relied only on traditional signs. Modern meteorologists welcome advanced technology that helps prevent flood disasters and saves lives.

The outcome of improved weather knowledge means communities can prepare for dangerous storms before they arrive. Someday, weather prediction may become so precise that flood warnings will be completely accurate days in advance.

Blood pressure often rises in people who experience severe weather anxiety, but knowledge about storm patterns helps reduce this stress. When communities become prepared for floods, the psychological outcome is much better for everyone involved.

Emergency shelters welcome families who must evacuate flood-prone areas. These facilities provide basic necessities like fresh scones and warm beverages to help people cope with displacement.
...
Like a wolf hunting for prey, severe weather seeks the most vulnerable areas. Communities that welcome scientific knowledge about flood prevention create better outcomes for everyone.`,
      ...
      {
        type: "persuasive",
        title: "Trust Scientific Knowledge",
        wordCount: 148,
        content: `Don't let ignorance become the outcome of your education! Welcome scientific knowledge with the same enthusiasm your ancestors showed for learning about their world, but don't cling to bygone beliefs that contradict modern evidence.

Some people's blood pressure rises when scientists challenge traditional ideas, but the outcome of ignoring scientific knowledge can be as dangerous as refusing flood warnings. Someday, this resistance to facts may become as outdated as believing wolves control the weather.

When the sun has shone on human civilization for thousands of years, we've learned that knowledge grows stronger with each generation. The woman or man who refuses to become educated creates unfortunate outcomes for their entire community.
...
The bygone era of trusting superstition over science led to tragic outcomes. Don't let fear or stubbornness prevent you from accepting knowledge that could help your community become safer and more prosperous.`,
      ...
      {
        type: "poetry",
        title: "Wisdom Through Time",
        wordCount: 147,
        content: `Someday I'll become quite wise,
With knowledge gleaming in my eyes.
I'll welcome truths both old and new,
And find the outcome strong and true.

The woman with her silver hair
Has knowledge gained through years of care.
Though sun has shone on bygone days,
She's learned to walk through wisdom's ways.

When flood waters rise up high,
And wolves howl beneath the sky,
Her blood runs steady, calm, and sure,
Her knowledge makes the outcome pure.

I welcome all she has to teach,
Her wisdom helps my mind to reach
Beyond the scone and simple bread
To deeper truths that must be fed.

Someday when I have grown old,
My knowledge will be worth more than gold.
Like her, I'll become a guide
With wisdom flowing deep inside.
...
It lights and guides you on your way.`,
  ...
  // LEVEL 4.15 - More Homophones
  {
    id: "4.15",
    level: "Level 4.15 - More Homophones",
    spellingFocus: "Complex homophones",
    targetWords: ["boarder", "border", "lessen", "lesson", "prey", "pray", "scene", "seen", "chews", "choose", "hoarse", "horse"],
    texts: [
      {
        type: "narrative",
        title: "The Boarder's Border Adventure",
        wordCount: 151,
        content: `Sarah was a foreign exchange student, a boarder living with the Johnson family near the border between two states. Her first lesson in American customs came when she had to choose what to pray for during the family's evening meal.

In her hoarse voice, still rough from her long journey, Sarah explained that she had never seen this scene before. Back home, families didn't pray together before meals, and she wasn't sure how to lessen her nervousness about joining in.

Mrs. Johnson's gentle lesson helped Sarah understand that each person could choose their own way to participate. "Some people pray silently," she explained, "while others just think grateful thoughts."

During dinner, Sarah watched the family dog chews his bone contentedly by the kitchen door. She realized that just like the dog who didn't worry about being a prey to anxiety, she didn't need to fear making mistakes.
...
Sarah's hoarse throat felt better as she learned that being seen and accepted was the greatest gift of all.`,
      ...
      },
      {
        ...
        wordCount: 149,
        content: `International student exchange programs help lessen cultural misunderstandings by allowing young people to live as a boarder in foreign families. These students learn valuable lessons about life across the border of their home countries.

A foreign student who has never seen certain cultural scenes before must choose how to adapt to new customs. Sometimes they prey on the patience of host families while learning, but most families pray for successful cultural exchanges.

Language barriers can make students' voices sound hoarse as they struggle to communicate. The lesson they learn is that patience and kindness help choose the best outcomes for everyone involved.
...
Host families help boarder students choose appropriate responses to new situations. Just as a horse chews grass naturally, students gradually develop comfort with unfamiliar customs through daily practice and gentle lessons about cultural differences.`,
      ...
      },
      {
        ...
        wordCount: 150,
        content: `Don't let fear become the prey that devours your opportunities for growth! Choose to embrace new experiences instead of allowing anxiety to lessen your potential for learning important life lessons.

Many students have never seen the scene of true cultural exchange, but those who choose to become a boarder in international programs discover that the border between different cultures is much smaller than they imagined.

Some people pray that change will never come, but wise students pray for courage to adapt when they encounter unfamiliar scenes. Don't let a hoarse voice of doubt convince you that new experiences will be too difficult.
...
Being a boarder in someone else's world, even temporarily, will lessen your prejudices and help you seen the beauty in different ways of living. Choose adventure over comfort, and let new experiences become the horse that carries you toward wisdom and understanding.`,
      ...
      },
      {
        ...
        wordCount: 148,
        content: `A boarder came across the border,
With lessons written in no order.
She'd never seen this kind of scene,
Where families gather, calm, serene.

Her voice was hoarse from traveling far,
Beneath each different, distant star.
She had to choose what words to say,
And learn the custom how to pray.

The lesson that she came to learn
Was how to lessen her concern.
Like horse that chews the sweetest grass,
She watched each moment slowly pass.

No longer prey to fear and doubt,
She learned what life is all about.
The border that had seemed so wide
Became a bridge from side to side.

She'd seen so many different scenes,
And learned what true belonging means.
To choose to pray for others' joy
Is lesson none can ever destroy.
