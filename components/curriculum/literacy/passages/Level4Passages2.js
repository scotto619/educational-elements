...
export const LEVEL_4_PASSAGES_2 = [
  // LEVEL 4.6 - AUGH & AU Patterns
  {
    id: "4.6",
    level: "Level 4.6 - AUGH & AU",
    spellingFocus: "augh and au sound patterns",
    targetWords: ["laughter", "laughed", "aunty", "sauce", "cause", "pause", "applause", "author", "August", "saucepan", "automatic", "dinosaur"],
    texts: [
      {
        type: "narrative",
        title: "Aunty's August Adventure",
        wordCount: 149,
        content: `Aunty Margaret was an author who wrote books about dinosaurs for children. Every August, she visited her nephew Tommy and always brought laughter to their house with her silly stories and funny voices.

This August was special because Aunty had written a new book about an automatic saucepan that could cook dinosaur sauce all by itself. Tommy laughed so hard when she read the story that he had to pause to catch his breath.

"The cause of this magic," Aunty explained in the story, "was a special ingredient that made the saucepan bubble with laughter." Tommy clapped his hands in applause as Aunty acted out each character.
...
"Every good author needs to know about cooking," Aunty laughed. "How else can you write about food?" Tommy giggled as he stirred, thinking about dinosaurs and automatic cooking pots that filled kitchens with the sound of laughter.`,
      ...
      {
        type: "informational",
        title: "The Life of Authors",
        wordCount: 152,
        content: `An author's life is filled with both laughter and hard work. Many authors begin writing in August when summer gives them a pause from other responsibilities, allowing them to focus on their creative projects.

Writing a book is rarely an automatic process. Authors must carefully develop their ideas, just like cooking a complex sauce in a saucepan requires patience and attention. The cause of many writing problems is rushing through the process without taking time to revise and improve.

When an author finishes a book, they often receive applause from readers who have laughed, cried, or learned something new. Children's authors, especially those who write about dinosaurs or fantasy creatures, bring special joy to young readers.
...
Whether an author writes about ancient dinosaurs or modern automatic machines, their goal is always the same: to cause readers to think, feel, and sometimes burst into laughter while reading. The applause of satisfied readers makes all the hard work worthwhile.`,
      ...
      {
        type: "persuasive",
        title: "Read Books by Different Authors",
        wordCount: 148,
        content: `Don't limit yourself to just one author or type of book! Reading widely will cause your mind to grow and fill your life with more laughter and learning opportunities.

This August, make it your automatic habit to explore new books. Pause your usual routine and visit the library to discover authors you've never heard of before. Your aunty, teacher, or librarian can suggest wonderful books that will earn your applause.

Some students only read about dinosaurs, while others prefer modern stories about automatic machines or cooking adventures. Both types of books have value! The cause of reading only one genre is often fear of trying something new.
...
Take a pause from your regular reading routine and applaud yourself for being brave enough to try new authors. The laughter and knowledge you'll gain will automatically make you a better reader and a more interesting person.`,
      ...
      {
        type: "poetry",
        title: "August Stories",
        wordCount: 147,
        content: `In August when the summer's bright,
My aunty comes to share delight.
She brings her books and stories new,
With laughter ringing clear and true.

The author's pen moves like a wand,
Creating worlds both near and fond.
She writes of dinosaurs so grand,
And sauce that's made by magic hand.

I pause to listen to each word,
About the automatic bird
That cooks and cleans with great applause,
While following the dinner laws.

The saucepan bubbles on the stove,
As August stories help me rove
Through lands where laughter never dies,
And dinosaurs light up the skies.

Each cause for joy she helps me find,
Through stories that expand my mind.
My aunty's automatic way
Of bringing wonder every day.
...
Makes every story feel brand new.`,
  ...
  // LEVEL 4.7 - SION Endings
  {
    id: "4.7",
    level: "Level 4.7 - SION Endings",
    spellingFocus: "sion ending patterns",
    targetWords: ["pension", "oppression", "session", "obsession", "progression", "procession", "regression", "expression", "aggression", "impression", "comprehension", "discussion"],
    texts: [
      {
        type: "narrative",
        title: "The Art Class Discussion",
        wordCount: 151,
        content: `Mrs. Chen's art session was always the highlight of Emma's week. Today, their discussion focused on different ways artists show expression through their paintings.

"Art can fight oppression and show progression in society," Mrs. Chen explained during their group discussion. Emma raised her hand with an impression that she wasn't sure she understood everything, but she wanted to contribute to the session.

"Some artists paint scenes of procession, like parades or celebrations," Emma shared, her comprehension growing as she spoke. The other students listened without aggression, creating a peaceful learning environment.

During the painting session, Emma noticed her friend Jake showing signs of regression in his technique. Instead of discussion, she quietly helped him improve his brush strokes. Her expression showed kindness rather than any form of aggression.
...
Mrs. Chen smiled at their thoughtful discussion, knowing this session had created lasting impressions on her students.`,
      ...
      {
        type: "informational",
        title: "Understanding History Through Change",
        wordCount: 149,
        content: `History shows us the progression of human society from ancient times to the present. Each generation's discussion of important issues creates an impression on the next, leading to continued social advancement.

Throughout history, people have fought against oppression through various forms of expression. Sometimes this involved peaceful procession marches, while other times it required more direct action to prevent regression in human rights.

Historical comprehension requires understanding that change often comes through long discussion and debate. Each session of government, from ancient councils to modern parliaments, contributes to social progression through careful consideration of different viewpoints.
...
The expression of ideas through art, literature, and discussion has always been crucial for fighting oppression. Each generation must have comprehensive understanding of the past to continue the progression toward a more just society.`,
      ...
      },
      {
        ...
        wordCount: 152,
        content: `Don't let shyness prevent you from joining classroom discussions! Your participation shows progression in learning and helps create better comprehension for everyone in the session.

Many students have the false impression that their ideas aren't worth sharing, but this kind of thinking leads to regression in confidence. Every discussion benefits from different viewpoints and expressions of understanding.

When you stay silent during a discussion session, you might develop an obsession with perfectionism that actually prevents learning progression. Speaking up, even when you're unsure, creates a positive impression on teachers and helps build your comprehension skills.

Classroom discussion isn't about aggression or competition – it's about collective learning and expression of ideas. Don't worry about oppression from judgment; most students are too focused on their own learning to criticize others harshly.
...
Your expression matters, and your participation creates a lasting impression that you're engaged in your education.`,
      ...
      },
      {
        ...
        wordCount: 148,
        content: `In every session we attend,
Discussion helps our minds to mend.
Through comprehension we can see
The progression toward being free.

No oppression of the mind
Can stop the truth that we will find.
Each expression that we share
Shows we deeply, truly care.

The impression that we make today
Helps chase regression far away.
Through peaceful discussion, not aggression,
We learn in every learning session.

Our obsession should be growth,
As we honor learning's oath.
Comprehension comes to those
Who let their true expression show.

In procession toward the light,
We discuss what's wrong and right.
No oppression can constrain
The progression of the brain.
...
The impression on the mind.`,
  ...
  // LEVEL 4.8 - TURE Endings
  {
    id: "4.8",
    level: "Level 4.8 - TURE Endings",
    spellingFocus: "ture ending patterns",
    targetWords: ["picture", "adventure", "rupture", "moisture", "capture", "departure", "agriculture", "culture", "fracture", "texture", "nurture", "feature"],
    texts: [
      {
        type: "narrative",
        title: "The Agriculture Adventure",
        wordCount: 153,
        content: `Sarah's family farm was the perfect picture of modern agriculture, where they worked to nurture both crops and culture within their community. This summer, Sarah's greatest adventure would be learning to capture the perfect growing conditions for their vegetables.

Her grandfather taught her to feel the texture of the soil and check for proper moisture levels. "Agriculture isn't just about planting," he explained. "You must nurture every feature of the growing process."

One morning, Sarah noticed a small fracture in the irrigation pipe that could cause a major rupture if not fixed quickly. Her quick thinking helped capture the problem before their departure for the farmer's market.

At the market, Sarah took a picture of their beautiful vegetables displayed for sale. She realized that agriculture was more than growing food – it was about nurturing community culture and bringing people together.
...
The picture she took that day would always capture the perfect moment when she understood the true feature of farming life.`,
      ...
      },
      {
        ...
        wordCount: 150,
        content: `Culture is like a delicate picture that requires careful nurture to prevent fracture over time. Every community must work to capture and preserve the important features of their heritage for future generations.

Traditional agriculture methods offer an excellent adventure in cultural preservation. Ancient farming techniques help maintain moisture in soil naturally and create healthy texture in crops without modern chemicals.

Museums and cultural centers work to capture the essence of different traditions before they rupture from modern society. Each artifact tells a picture of life in earlier times, showing features of daily culture that might otherwise be lost.

When families plan their departure from traditional ways, something important can fracture in the community. The texture of cultural life becomes thinner when people don't nurture their connections to the past.
...
Agriculture, art, and storytelling all work together to nurture culture and prevent the fracture of community connections.`,
      ...
      {
        type: "persuasive",
        title: "Protect Our Natural Environment",
        wordCount: 148,
        content: `The picture of environmental destruction should capture everyone's attention and inspire immediate action to nurture our planet's health! Don't let the texture of natural beauty fracture due to careless human behavior.

Our departure from sustainable agriculture has created a dangerous rupture in the relationship between humans and nature. We must capture this moment to change direction before moisture levels in soil and air reach critical points.

Every small action you take to nurture the environment becomes an adventure in positive change. Whether you grow plants to add moisture to the air or take a picture to capture nature's beauty, your efforts contribute to healing cultural connections with the natural world.
...
Don't wait for your departure from childhood to start caring about environmental issues. Capture every opportunity to nurture sustainable practices and help heal the fracture between human culture and natural systems.`,
      ...
      },
      {
        ...
        wordCount: 147,
        content: `The picture of morning dew so bright
Captures moisture in the light.
Each adventure that I take
Shows the fracture we can break.

Agriculture feeds the world,
But culture must be carefully unfurled.
We nurture what we hope to keep,
And capture memories we'll always reap.

The texture of the earth so rich
Needs our care without a hitch.
Before departure from this place,
We must nurture with gentle grace.

Each feature of the natural scene
Creates the picture of all we've seen.
No rupture in this texture fine
Should break this heritage of mine.

Adventure calls from hill and tree,
Where moisture helps the flowers be.
The culture of the earth runs deep,
These treasures we must always keep.
...
When we protect what we can see.`,
  ...
  // LEVEL 4.9 - EL Endings
  {
    id: "4.9",
    level: "Level 4.9 - EL Endings",
    spellingFocus: "el ending patterns",
    targetWords: ["scoundrel", "counsel", "parallel", "quarrel", "compel", "sequel", "grovel", "apparel", "cancel", "marvel", "swivel", "propel"],
    texts: [
      {
        type: "narrative",
        title: "The Swivel Chair Mystery",
        wordCount: 148,
        content: `Detective Martinez sat in her swivel chair, studying the parallel clues that would help solve the mystery of the missing apparel from the school costume closet. She didn't want to cancel the spring play, but someone had stolen all the costumes.

"I counsel patience," she told the worried drama teacher. "Don't quarrel with the students yet. Let me marvel at these clues first." The detective began to propel herself around the room in her swivel chair, thinking carefully.

The first clue showed parallel scratches on the door frame. The second sequel of evidence pointed to someone who would grovel for attention. Detective Martinez realized she needed to compel the truth from someone who was acting like a scoundrel.
...
Detective Martinez helped counsel Tommy through his stage fright, and they decided not to quarrel about the missing costumes. The parallel lesson was clear: sometimes a scoundrel just needs understanding rather than punishment.`,
      ...
      },
      {
        ...
        wordCount: 151,
        content: `Effective problem-solving requires the ability to examine parallel solutions and counsel yourself through different approaches. Don't cancel your efforts just because the first attempt doesn't work perfectly.

When you encounter a challenge, resist the urge to quarrel with others or grovel for easy answers. Instead, marvel at the complexity of the problem and allow yourself to swivel between different perspectives.

Sometimes you must compel yourself to consider solutions that seem like a sequel to previous failed attempts. A good problem-solver doesn't act like a scoundrel by giving up or blaming others when things get difficult.

Professional counselors advise students to examine parallel examples of similar problems and their solutions. This approach can propel your thinking in new directions and help you discover innovative approaches.
...
Marvel at how much you can learn from each attempt, and remember that finding solutions often requires the ability to swivel your thinking toward unexpected possibilities.`,
      ...
      {
        type: "persuasive",
        title: "Don't Give Up on Learning",
        wordCount: 149,
        content: `Don't cancel your dreams just because learning feels difficult sometimes! Every successful person has parallel stories of struggle before achievement, and you shouldn't grovel for easy solutions to complex challenges.

When you quarrel with difficult subjects or want to swivel away from hard work, remember that these challenges will propel you toward greater understanding. Don't be a scoundrel who gives up at the first sign of trouble.

I counsel you to marvel at your own ability to learn and grow, even when progress seems slow. Every sequel to your educational journey builds on previous knowledge and experience.

Sometimes teachers must compel students to attempt challenging work, but this isn't meant to be punishment. Like choosing appropriate apparel for different occasions, you need different skills for different situations.
...
Counsel yourself with patience and determination. Marvel at how much you've already learned, and don't quarrel with the process of education that will ultimately propel you toward success.`,
      ...
      },
      {
        ...
        wordCount: 146,
        content: `I swivel in my chair and think
About the parallel paths we link.
Don't cancel dreams that seem too far,
Just marvel at how strong you are.

When troubles make you want to grovel,
Remember how your mind can swivel.
The counsel that I give to you:
Don't quarrel with what you must do.

Let challenges propel you high,
Don't be a scoundrel who won't try.
Each sequel to your learning tale
Will help you grow and never fail.

The apparel that you choose to wear
Shows parallel amounts of care.
So compel yourself to do your best,
And marvel at each little test.

Don't cancel hopes when things seem hard,
Let learning be your winning card.
Through parallel lines of thought so true,
...
Just marvel how much you have grown.`,
  ...
  // LEVEL 4.10 - AU Patterns  
  {
    id: "4.10",
    level: "Level 4.10 - AU Patterns",
    spellingFocus: "au and aw sound patterns",
    targetWords: ["because", "Australia", "assault", "cauliflower", "hydraulic", "auction", "caustic", "fault", "default", "sausage", "vault", "somersault"],
    texts: [
      {
        type: "narrative",
        title: "The Australian Auction Adventure",
        wordCount: 150,
        content: `Jake's family moved to Australia because his father got a job repairing hydraulic systems on farms. Their first big adventure was attending a local auction where farmers sold equipment and produce.

"Look at that vault of treasures!" Jake exclaimed, pointing to a collection of old farming tools. The auctioneer was selling everything from cauliflower seeds to hydraulic pumps.

Jake's little sister attempted a somersault in the grass while they waited for the sausage auction to begin. "It's not my fault if I get dizzy," she giggled, trying another flip.

Suddenly, a farmer began shouting about a caustic chemical spill near the hydraulic equipment. It wasn't anyone's fault, but the default safety procedure was to evacuate the area immediately.
...
Later, they learned that Australia has strict rules about caustic materials because farming communities must protect everyone from harm. The auction resumed once the cleanup was complete, and Jake's family successfully bid on a box of fresh cauliflower.`,
      ...
      },
      {
        ...
        wordCount: 148,
        content: `Agricultural safety is extremely important because farmers work with powerful hydraulic machinery, caustic chemicals, and heavy equipment every day. In countries like Australia, strict safety rules help prevent accidents that could assault workers' health.

Many farm accidents happen because someone assumes that equipment malfunction is their fault, leading to unsafe attempts at quick repairs. The default response should always be to follow proper safety procedures rather than taking dangerous shortcuts.

Hydraulic systems operate under extreme pressure and can cause serious injury if they malfunction. Farmers must inspect these systems regularly to prevent default failures that could result in hydraulic fluid assault on workers.
...
Safety training teaches workers that some accidents aren't anyone's fault, but prevention is always possible through careful attention to procedures. Whether you're operating hydraulic equipment or handling caustic substances, following safety protocols should never be considered optional.`,
      ...
      {
        type: "persuasive",
        title: "Learn About Different Countries",
        wordCount: 152,
        content: `Don't let ignorance about other countries become your default attitude! Learning about places like Australia will expand your understanding and prevent cultural misunderstandings that could assault your future opportunities.

Many students think learning about foreign countries isn't their fault if they find it boring, but this attitude limits their potential. Australia, for example, has fascinating wildlife, unique hydraulic mining operations, and agricultural innovations that could amaze you.

Because global communication connects us all, cultural knowledge has become as essential as understanding caustic safety warnings or hydraulic system operations. You can't store yourself in a vault of ignorance and expect to succeed in our connected world.
...
The default setting for successful students is curiosity about the world beyond their immediate experience. Because international understanding prevents the assault of prejudice and ignorance, studying different countries should be a priority, not an optional activity.`,
      ...
      {
        type: "poetry",
        title: "Down Under Dreams",
        wordCount: 147,
        content: `Australia calls from far away,
Because adventure starts today.
No vault can hold my dreams so tight,
I'll somersault with pure delight.

The hydraulic systems hum and whir,
While farmers plant and harvest, sir.
It's not their fault the work is hard,
They tend each crop and tend each yard.

At auction time the people meet,
With sausage, cauliflower sweet.
The default setting here is care,
For land and livestock everywhere.

No caustic words or harsh assault
Can make this culture be at fault.
Because the people work as one,
Australia shines beneath the sun.

I dream of visiting that land,
Where farmers work with skilled hand.
The vault of knowledge I will fill
With stories from that southern hill.
