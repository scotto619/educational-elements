...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-magic': 'linear-gradient(45deg, #667eea 0%, #764ba2 100%)',
        'gradient-gold': 'linear-gradient(45deg, #f59e0b 0%, #d97706 100%)',
        'gradient-nature': 'linear-gradient(45deg, #10b981 0%, #059669 100%)',
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
