...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    sections: [
      ...
      { id: 'spelling-features', name: 'Spelling Features',          emoji: '🔡', bg: 'bg-amber-100',   border: 'border-amber-300',   hover: 'hover:bg-amber-200',   text: 'text-amber-900',   images: [{ name: 'A', file: 'Spelling/Spelling Features/a.png' },{ name: 'B', file: 'Spelling/Spelling Features/b.png' },{ name: 'C', file: 'Spelling/Spelling Features/c.png' },{ name: 'D', file: 'Spelling/Spelling Features/d.png' },{ name: 'E', file: 'Spelling/Spelling Features/e.png' },{ name: 'F', file: 'Spelling/Spelling Features/f.png' },{ name: 'G', file: 'Spelling/Spelling Features/g.png' },{ name: 'H', file: 'Spelling/Spelling Features/h.png' },{ name: 'I', file: 'Spelling/Spelling Features/i.png' },{ name: 'J', file: 'Spelling/Spelling Features/j.png' },{ name: 'K', file: 'Spelling/Spelling Features/k.png' }] },
      ...
      { id: 'writing-narrative-gr6', name: 'Narrative Writing — Grade 6', emoji: '📖', bg: 'bg-amber-100', border: 'border-amber-300', hover: 'hover:bg-amber-200', text: 'text-amber-900', images: [{ name: 'A', file: 'Writing/Narrative/Grade 6/a.png' },{ name: 'B', file: 'Writing/Narrative/Grade 6/b.png' },{ name: 'C', file: 'Writing/Narrative/Grade 6/c.png' }] },
      ...
      { id: 'writing-procedure-gr6', name: 'Procedure Writing — Grade 6', emoji: '📋', bg: 'bg-blue-100', border: 'border-blue-300', hover: 'hover:bg-blue-200', text: 'text-blue-900', images: [{ name: 'A', file: 'Writing/Procedure/Grade 6/a.png' },{ name: 'B', file: 'Writing/Procedure/Grade 6/b.png' },{ name: 'C', file: 'Writing/Procedure/Grade 6/c.png' }] },
      { id: 'writing-procedure-gr1', name: 'Procedure Writing — Grade 1', emoji: '📋', bg: 'bg-gray-100', border: 'border-gray-300', hover: 'hover:bg-gray-200', text: 'text-gray-900', images: [{ name: 'A', file: 'Writing/Procedure/Grade 1/a.png' },{ name: 'B', file: 'Writing/Procedure/Grade 1/b.png' },{ name: 'C', file: 'Writing/Procedure/Grade 1/c.png' }] },
      ...
      { id: 'writing-informative-gr6', name: 'Informative Writing — Grade 6', emoji: '📰', bg: 'bg-emerald-100', border: 'border-emerald-300', hover: 'hover:bg-emerald-200', text: 'text-emerald-900', images: [{ name: 'A', file: 'Writing/Informative/Grade 6/a.png' },{ name: 'B', file: 'Writing/Informative/Grade 6/b.png' },{ name: 'C', file: 'Writing/Informative/Grade 6/c.png' }] },
      { id: 'writing-informative-gr1', name: 'Informative Writing — Grade 1', emoji: '📰', bg: 'bg-pink-100', border: 'border-pink-300', hover: 'hover:bg-pink-200', text: 'text-pink-900', images: [{ name: 'A', file: 'Writing/Informative/Grade 1/a.png' },{ name: 'B', file: 'Writing/Informative/Grade 1/b.png' },{ name: 'C', file: 'Writing/Informative/Grade 1/c.png' }] },
      ...
      { id: 'writing-persuasive-3', name: 'Persuasive Writing 3',   emoji: '💬', bg: 'bg-purple-100',  border: 'border-purple-300',  hover: 'hover:bg-purple-200',  text: 'text-purple-900',  images: [{ name: '1', file: 'Writing/Persuasive 3/1.png' },{ name: '2', file: 'Writing/Persuasive 3/2.png' },{ name: '3', file: 'Writing/Persuasive 3/3.png' },{ name: '4', file: 'Writing/Persuasive 3/4.png' },{ name: '5', file: 'Writing/Persuasive 3/5.png' },{ name: '6', file: 'Writing/Persuasive 3/6.png' },{ name: '7', file: 'Writing/Persuasive 3/7.png' },{ name: '8', file: 'Writing/Persuasive 3/8.png' }] },
      { id: 'writing-persuasive-gr6', name: 'Persuasive Writing — Grade 6', emoji: '💬', bg: 'bg-green-100', border: 'border-green-300', hover: 'hover:bg-green-200', text: 'text-green-900', images: [{ name: 'A', file: 'Writing/Persuasive/Grade 6/a.png' },{ name: 'B', file: 'Writing/Persuasive/Grade 6/b.png' },{ name: 'C', file: 'Writing/Persuasive/Grade 6/c.png' }] },
      { id: 'writing-persuasive-prompts', name: 'Persuasive Writing Prompts', emoji: '💬', bg: 'bg-slate-100', border: 'border-slate-300', hover: 'hover:bg-slate-200', text: 'text-slate-900', images: [{ name: 'A', file: 'Writing/Persuasive/Prompts/a.png' },{ name: 'B', file: 'Writing/Persuasive/Prompts/b.png' },{ name: 'C', file: 'Writing/Persuasive/Prompts/c.png' },{ name: 'D', file: 'Writing/Persuasive/Prompts/d.png' },{ name: 'E', file: 'Writing/Persuasive/Prompts/e.png' },{ name: 'F', file: 'Writing/Persuasive/Prompts/f.png' },{ name: 'G', file: 'Writing/Persuasive/Prompts/g.png' },{ name: 'H', file: 'Writing/Persuasive/Prompts/h.png' },{ name: 'I', file: 'Writing/Persuasive/Prompts/i.png' },{ name: 'J', file: 'Writing/Persuasive/Prompts/j.png' }] },
      ...
      { id: 'writing-recount-gr1', name: 'Recount & Retell Writing — Grade 1', emoji: '📝', bg: 'bg-rose-100', border: 'border-rose-300', hover: 'hover:bg-rose-200', text: 'text-rose-900', images: [{ name: 'A', file: 'Writing/Recount or Retell/Grade 1/a.png' },{ name: 'B', file: 'Writing/Recount or Retell/Grade 1/b.png' },{ name: 'C', file: 'Writing/Recount or Retell/Grade 1/c.png' }] },
      ...
      { id: 'ws-comprehension-text-4', name: 'Comprehension — Text Highlighting 4 (Text Structures)', emoji: '🖊️', bg: 'bg-red-100',    border: 'border-red-300',     hover: 'hover:bg-red-200',     text: 'text-red-900',     images: [{ name: 'A', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/a.png' },{ name: 'B', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/b.png' },{ name: 'C', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/c.png' },{ name: 'D', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/d.png' },{ name: 'E', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/e.png' },{ name: 'F', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/f.png' },{ name: 'G', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/g.png' },{ name: 'H', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/h.png' },{ name: 'I', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/i.png' },{ name: 'J', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/j.png' },{ name: 'K', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/k.png' },{ name: 'L', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/l.png' },{ name: 'M', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/m.png' },{ name: 'N', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/n.png' },{ name: 'O', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/o.png' },{ name: 'P', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/p.png' },{ name: 'Q', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/q.png' },{ name: 'R', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/r.png' },{ name: 'S', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/s.png' },{ name: 'T', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/t.png' },{ name: 'U', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/u.png' },{ name: 'V', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/v.png' },{ name: 'W', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/w.png' },{ name: 'X', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/x.png' },{ name: 'Y', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/y.png' },{ name: 'Z', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/z.png' },{ name: 'Z2', file: 'Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/z2.png' }] },
      { id: 'reading-inferencing-gr3', name: 'Inferencing — Grade 3', emoji: '🔍', bg: 'bg-lime-100', border: 'border-lime-300', hover: 'hover:bg-lime-200', text: 'text-lime-900', images: [{ name: 'A', file: 'Reading/Inferencing/Grade 3/a.png' },{ name: 'B', file: 'Reading/Inferencing/Grade 3/b.png' },{ name: 'C', file: 'Reading/Inferencing/Grade 3/c.png' },{ name: 'D', file: 'Reading/Inferencing/Grade 3/d.png' },{ name: 'E', file: 'Reading/Inferencing/Grade 3/e.png' },{ name: 'F', file: 'Reading/Inferencing/Grade 3/f.png' }] },
      { id: 'reading-strategies-my', name: 'Reading Strategies — Middle Years', emoji: '🧠', bg: 'bg-cyan-100', border: 'border-cyan-300', hover: 'hover:bg-cyan-200', text: 'text-cyan-900', images: [{ name: 'A', file: 'Reading/Reading Strategies/Middle Years/a.png' },{ name: 'B', file: 'Reading/Reading Strategies/Middle Years/b.png' },{ name: 'C', file: 'Reading/Reading Strategies/Middle Years/c.png' },{ name: 'D', file: 'Reading/Reading Strategies/Middle Years/d.png' },{ name: 'E', file: 'Reading/Reading Strategies/Middle Years/e.png' },{ name: 'F', file: 'Reading/Reading Strategies/Middle Years/f.png' },{ name: 'G', file: 'Reading/Reading Strategies/Middle Years/g.png' },{ name: 'H', file: 'Reading/Reading Strategies/Middle Years/h.png' },{ name: 'I', file: 'Reading/Reading Strategies/Middle Years/i.png' },{ name: 'J', file: 'Reading/Reading Strategies/Middle Years/j.png' }] },
      { id: 'reading-fact-files-countries', name: 'Fact Files — Countries', emoji: '🌍', bg: 'bg-blue-100', border: 'border-blue-300', hover: 'hover:bg-blue-200', text: 'text-blue-900', images: [{ name: 'A', file: 'Reading/Fact Files/Countries/a.png' },{ name: 'A2', file: 'Reading/Fact Files/Countries/a1.png' },{ name: 'A3', file: 'Reading/Fact Files/Countries/a2.png' },{ name: 'A4', file: 'Reading/Fact Files/Countries/a3.png' },{ name: 'A5', file: 'Reading/Fact Files/Countries/a4.png' },{ name: 'A6', file: 'Reading/Fact Files/Countries/a5.png' },{ name: 'B', file: 'Reading/Fact Files/Countries/b.png' },{ name: 'B2', file: 'Reading/Fact Files/Countries/b1.png' },{ name: 'B3', file: 'Reading/Fact Files/Countries/b2.png' },{ name: 'B4', file: 'Reading/Fact Files/Countries/b3.png' },{ name: 'B5', file: 'Reading/Fact Files/Countries/b4.png' },{ name: 'B6', file: 'Reading/Fact Files/Countries/b5.png' },{ name: 'C', file: 'Reading/Fact Files/Countries/c.png' },{ name: 'C2', file: 'Reading/Fact Files/Countries/c1.png' },{ name: 'C3', file: 'Reading/Fact Files/Countries/c2.png' },{ name: 'C4', file: 'Reading/Fact Files/Countries/c3.png' },{ name: 'D', file: 'Reading/Fact Files/Countries/d.png' },{ name: 'E', file: 'Reading/Fact Files/Countries/e.png' },{ name: 'F', file: 'Reading/Fact Files/Countries/f.png' },{ name: 'G', file: 'Reading/Fact Files/Countries/g.png' },{ name: 'H', file: 'Reading/Fact Files/Countries/h.png' },{ name: 'I', file: 'Reading/Fact Files/Countries/i.png' },{ name: 'J', file: 'Reading/Fact Files/Countries/j.png' },{ name: 'K', file: 'Reading/Fact Files/Countries/k.png' },{ name: 'L', file: 'Reading/Fact Files/Countries/l.png' },{ name: 'M', file: 'Reading/Fact Files/Countries/m.png' },{ name: 'N', file: 'Reading/Fact Files/Countries/n.png' },{ name: 'O', file: 'Reading/Fact Files/Countries/o.png' },{ name: 'P', file: 'Reading/Fact Files/Countries/p.png' },{ name: 'Q', file: 'Reading/Fact Files/Countries/q.png' },{ name: 'R', file: 'Reading/Fact Files/Countries/r.png' },{ name: 'S', file: 'Reading/Fact Files/Countries/s.png' },{ name: 'T', file: 'Reading/Fact Files/Countries/t.png' },{ name: 'U', file: 'Reading/Fact Files/Countries/u.png' },{ name: 'V', file: 'Reading/Fact Files/Countries/v.png' },{ name: 'W', file: 'Reading/Fact Files/Countries/w.png' },{ name: 'X', file: 'Reading/Fact Files/Countries/x.png' },{ name: 'Y', file: 'Reading/Fact Files/Countries/y.png' },{ name: 'Z', file: 'Reading/Fact Files/Countries/z.png' }] },
      ...
      { id: 'ws-language-features-narratives', name: 'Language Features — Narratives', emoji: '✏️', bg: 'bg-green-100', border: 'border-green-300', hover: 'hover:bg-green-200', text: 'text-green-900', images: [{ name: 'A', file: 'Worksheets/Writing/Language Features/Narratives/a.png' },{ name: 'B', file: 'Worksheets/Writing/Language Features/Narratives/b.png' },{ name: 'C', file: 'Worksheets/Writing/Language Features/Narratives/c.png' },{ name: 'D', file: 'Worksheets/Writing/Language Features/Narratives/d.png' },{ name: 'E', file: 'Worksheets/Writing/Language Features/Narratives/e.png' },{ name: 'F', file: 'Worksheets/Writing/Language Features/Narratives/f.png' },{ name: 'G', file: 'Worksheets/Writing/Language Features/Narratives/g.png' },{ name: 'H', file: 'Worksheets/Writing/Language Features/Narratives/h.png' },{ name: 'I', file: 'Worksheets/Writing/Language Features/Narratives/i.png' },{ name: 'J', file: 'Worksheets/Writing/Language Features/Narratives/j.png' },{ name: 'K', file: 'Worksheets/Writing/Language Features/Narratives/k.png' },{ name: 'L', file: 'Worksheets/Writing/Language Features/Narratives/l.png' },{ name: 'M', file: 'Worksheets/Writing/Language Features/Narratives/m.png' }] },
      { id: 'ws-language-features-informative', name: 'Language Features — Informative', emoji: '✏️', bg: 'bg-emerald-100', border: 'border-emerald-300', hover: 'hover:bg-emerald-200', text: 'text-emerald-900', images: [{ name: 'A', file: 'Worksheets/Writing/Language Features/Informative/a.png' },{ name: 'B', file: 'Worksheets/Writing/Language Features/Informative/b.png' },{ name: 'C', file: 'Worksheets/Writing/Language Features/Informative/c.png' },{ name: 'D', file: 'Worksheets/Writing/Language Features/Informative/d.png' },{ name: 'E', file: 'Worksheets/Writing/Language Features/Informative/e.png' },{ name: 'F', file: 'Worksheets/Writing/Language Features/Informative/f.png' },{ name: 'G', file: 'Worksheets/Writing/Language Features/Informative/g.png' },{ name: 'H', file: 'Worksheets/Writing/Language Features/Informative/h.png' },{ name: 'I', file: 'Worksheets/Writing/Language Features/Informative/i.png' },{ name: 'J', file: 'Worksheets/Writing/Language Features/Informative/j.png' }] },
      { id: 'ws-language-features-persuasive', name: 'Language Features — Persuasive', emoji: '✏️', bg: 'bg-orange-100', border: 'border-orange-300', hover: 'hover:bg-orange-200', text: 'text-orange-900', images: [{ name: 'A', file: 'Worksheets/Writing/Language Features/Persuasive/a.png' },{ name: 'B', file: 'Worksheets/Writing/Language Features/Persuasive/b.png' },{ name: 'C', file: 'Worksheets/Writing/Language Features/Persuasive/c.png' },{ name: 'D', file: 'Worksheets/Writing/Language Features/Persuasive/d.png' },{ name: 'E', file: 'Worksheets/Writing/Language Features/Persuasive/e.png' },{ name: 'F', file: 'Worksheets/Writing/Language Features/Persuasive/f.png' },{ name: 'G', file: 'Worksheets/Writing/Language Features/Persuasive/g.png' },{ name: 'H', file: 'Worksheets/Writing/Language Features/Persuasive/h.png' },{ name: 'I', file: 'Worksheets/Writing/Language Features/Persuasive/i.png' }] },
    ...
    groups: [
      { id: 'eng-displays',        name: 'Displays',         emoji: '🖼️', sectionIds: ['grammar-nouns-pack','grammar-verbs-pack','grammar-adjectives-pack','grammar-displays','punctuation-displays','letters','alphabet-2','vowels','phonics-blends-2','spelling-rules','spelling-strats','spelling-features','english-anchor-charts','english-anchor-charts-2'] },
      { id: 'eng-writing-displays',name: 'Writing Displays', emoji: '✍️', sectionIds: ['writing-narrative','writing-narrative-prompts','writing-narrative-forest','writing-narrative-gr6','writing-procedure','writing-procedure-2','writing-procedure-3','writing-procedure-gr6','writing-procedure-gr1','writing-paragraph','writing-persuasive-2','writing-persuasive-3','writing-paragraph-2','writing-creative','writing-sentence','writing-informative','writing-informative-ocean','writing-informative-animals','writing-informative-gr6','writing-informative-gr1','writing-information-report','writing-persuasive','writing-persuasive-gr6','writing-persuasive-prompts','writing-poetry','writing-recount','writing-recount-gr1','literary-devices','book-review','writing-research-skills'] },
      { id: 'eng-worksheets',      name: 'Worksheets',       emoji: '📄', sectionIds: ['ws-grammar','ws-writing','ws-writing-cute','ws-sentence-to-paragraphs','ws-hypotheticals','ws-language-features-narratives','ws-language-features-informative','ws-language-features-persuasive','ws-writing-templates','ws-booklets','ws-booklets-2','ws-story-builders'] },
      { id: 'eng-comprehension',   name: 'Comprehension',    emoji: '📖', sectionIds: ['ws-comprehension-yr','ws-comprehension-yr2','ws-comprehension-ah','ws-comprehension-slang','ws-comprehension-mythical','ws-comprehension-text','ws-comprehension-text-2','ws-comprehension-text-3-lower','ws-comprehension-text-3','ws-comprehension-text-4','reading-inferencing-gr3','reading-strategies-my','reading-fact-files-countries'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'decor-rock-n-roll', name: 'Rock n Roll Theme', emoji: '🎸', bg: 'bg-red-100', border: 'border-red-300', hover: 'hover:bg-red-200', text: 'text-red-900', images: [{ name: 'A', file: 'Rock n Roll/a.png' },{ name: 'B', file: 'Rock n Roll/b.png' },{ name: 'C', file: 'Rock n Roll/c.png' },{ name: 'D', file: 'Rock n Roll/d.png' },{ name: 'E', file: 'Rock n Roll/e.png' },{ name: 'F', file: 'Rock n Roll/f.png' },{ name: 'G', file: 'Rock n Roll/g.png' },{ name: 'H', file: 'Rock n Roll/h.png' },{ name: 'I', file: 'Rock n Roll/i.png' }] },
    ],
    groups: [
      { id: 'decor-themes', name: 'Themes', emoji: '🎨', sectionIds: ['decor-beach','decor-cherry-blossom','decor-sweet-treats','decor-magical','decor-watercolour','decor-rock-n-roll'] },
    ],
  },
  {
...
const RECENTLY_ADDED = [
  { src: '/Displays/English/Writing/Persuasive 3/1.png',                              label: 'Persuasive Writing 3',                 subject: 'English' },
  { src: '/Displays/English/Worksheets/Writing/Language Features/Informative/a.png', label: 'Language Features — Informative',      subject: 'English' },
  { src: '/Displays/English/Worksheets/Writing/Language Features/Persuasive/a.png',  label: 'Language Features — Persuasive',       subject: 'English' },
  { src: '/Displays/English/Reading/Fact Files/Countries/a.png',                     label: 'Fact Files — Countries',               subject: 'English' },
  { src: '/Displays/English/Worksheets/Writing/Language Features/Narratives/a.png',  label: 'Language Features — Narratives',       subject: 'English' },
  { src: '/Displays/English/Spelling/Spelling Features/a.png',                        label: 'Spelling Features',                     subject: 'English' },
  { src: '/Displays/English/Reading/Reading Strategies/Middle Years/a.png',          label: 'Reading Strategies — Middle Years',     subject: 'English' },
  { src: '/Displays/English/Writing/Informative/Grade 1/a.png',                      label: 'Informative Writing — Grade 1',         subject: 'English' },
  { src: '/Displays/English/Writing/Persuasive/Prompts/a.png',                       label: 'Persuasive Writing Prompts',            subject: 'English' },
  { src: '/Displays/English/Writing/Procedure/Grade 1/a.png',                        label: 'Procedure Writing — Grade 1',           subject: 'English' },
  { src: '/Displays/English/Writing/Recount or Retell/Grade 1/a.png',               label: 'Recount & Retell Writing — Grade 1',    subject: 'English' },
  { src: '/Displays/Decor/Rock n Roll/a.png',                                       label: 'Rock n Roll Theme',                    subject: 'Decor' },
  { src: '/Displays/English/Reading/Inferencing/Grade 3/a.png',                     label: 'Inferencing — Grade 3',                subject: 'English' },
  { src: '/Displays/English/Writing/Informative/Grade 6/a.png',                     label: 'Informative Writing — Grade 6',        subject: 'English' },
  { src: '/Displays/English/Writing/Narrative/Grade 6/a.png',                       label: 'Narrative Writing — Grade 6',          subject: 'English' },
  { src: '/Displays/English/Writing/Persuasive/Grade 6/a.png',                      label: 'Persuasive Writing — Grade 6',         subject: 'English' },
  { src: '/Displays/English/Writing/Procedure/Grade 6/a.png',                       label: 'Procedure Writing — Grade 6',          subject: 'English' },
  { src: '/Displays/English/Worksheets/Comprehension/Text Highlighting 4 (Text Structures)/a.png', label: 'Comprehension — Text Highlighting 4 (Text Structures)', subject: 'English' },
  ...
  english: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'spelling-features',   title: 'Spelling Features',         icon: '🔡', pdfPath: '/Unit Resources/English/Spelling_Features.pdf' },
      ],
    },
    {
      ...
      items: [
        ...
        { id: 'informative-gr6',         title: 'Informative Writing — Grade 6', icon: '📰', pdfPath: '/Unit Resources/English/Informative_Grade_6.pdf' },
        { id: 'informative-gr1',         title: 'Informative Writing — Grade 1', icon: '📰', pdfPath: '/Unit Resources/English/Informative_Grade_1.pdf' },
        ...
        { id: 'narrative-gr6',           title: 'Narrative Writing — Grade 6', icon: '📖', pdfPath: '/Unit Resources/English/Narrative_Grade_6.pdf' },
        { id: 'recount-gr1',             title: 'Recount & Retell Writing — Grade 1', icon: '📝', pdfPath: '/Unit Resources/English/Recount_Grade_1.pdf' },
        ...
        { id: 'procedure-gr6',             title: 'Procedure Writing — Grade 6', icon: '📋', pdfPath: '/Unit Resources/English/Procedure_Grade_6.pdf' },
        { id: 'procedure-gr1',             title: 'Procedure Writing — Grade 1', icon: '📋', pdfPath: '/Unit Resources/English/Procedure_Grade_1.pdf' },
        { id: 'persuasive-writing-2',      title: 'Persuasive Writing 2',      icon: '💬', pdfPath: '/Unit Resources/English/Persuasive_Writing_2.pdf' },
        { id: 'persuasive-writing-3',      title: 'Persuasive Writing 3',      icon: '💬', pdfPath: '/Unit Resources/English/Persuasive_Writing_3.pdf' },
        { id: 'persuasive-gr6',            title: 'Persuasive Writing — Grade 6',   icon: '💬', pdfPath: '/Unit Resources/English/Persuasive_Grade_6.pdf' },
        { id: 'persuasive-prompts',        title: 'Persuasive Writing Prompts',     icon: '💬', pdfPath: '/Unit Resources/English/Persuasive_Writing_Prompts.pdf' },
        ...
        { id: 'language-features-narratives',  title: 'Language Features — Narratives',  icon: '✏️', pdfPath: '/Unit Resources/English/Language_Features_Narratives.pdf' },
        { id: 'language-features-informative', title: 'Language Features — Informative', icon: '✏️', pdfPath: '/Unit Resources/English/Language_Features_Informative.pdf' },
        { id: 'language-features-persuasive',  title: 'Language Features — Persuasive',  icon: '✏️', pdfPath: '/Unit Resources/English/Language_Features_Persuasive.pdf' },
      ],
    },
    {
      ...
      items: [
        ...
        { id: 'text-highlighting-4',      title: 'Comprehension — Text Highlighting 4 (Text Structures)', icon: '🖊️', pdfPath: '/Unit Resources/English/Text_Highlighting_4.pdf' },
        { id: 'inferencing-gr3',          title: 'Inferencing — Grade 3',                  icon: '🔍', pdfPath: '/Unit Resources/English/Inferencing_Grade_3.pdf' },
        { id: 'reading-strategies-my',    title: 'Reading Strategies — Middle Years',     icon: '🧠', pdfPath: '/Unit Resources/English/Reading_Strategies_Middle_Years.pdf' },
        { id: 'fact-files-countries',     title: 'Fact Files — Countries',                icon: '🌍', pdfPath: '/Unit Resources/English/Fact_Files_Countries.pdf' },
      ],
    },
    {
  ...
  decor: [
    {
      ...
      items: [
        ...
        { id: 'decor-rock-n-roll', title: 'Rock n Roll Theme Classroom Decor', icon: '🎸', pdfPath: '/Unit Resources/Decor/Rock_n_Roll_Theme.pdf' },
      ],
    },
  ],
  teacher: [
...
const SECTION_CATEGORY_OVERRIDES = {
  english: {
    ...
    'Phonics & Spelling': ['alphabet-2', 'eye-spy', 'cvc-cards', 'phonics-blends', 'phonics-blends-2', 'vowels', 'spelling-rules', 'spelling-strats', 'spelling-features'],
    'Writing': ['writing-persuasive', 'writing-persuasive-2', 'writing-persuasive-3', 'writing-persuasive-gr6', 'writing-persuasive-prompts', 'writing-poetry', 'writing-recount', 'writing-recount-gr1', 'book-review', 'ws-writing', 'ws-language-features-narratives', 'ws-language-features-informative', 'ws-language-features-persuasive'],
    'Reading & Comprehension': ['ws-comprehension-yr', 'ws-comprehension-yr2', 'ws-comprehension-ah', 'ws-comprehension-slang', 'reading-inferencing-gr3', 'reading-strategies-my', 'reading-fact-files-countries'],
