...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    groups: [
      { id: 'eng-displays',        name: 'Displays',         emoji: '🖼️', sectionIds: ['grammar-displays','punctuation-displays','letters','alphabet-2','vowels','phonics-blends-2','spelling-rules','spelling-strats','english-anchor-charts','english-anchor-charts-2'] },
      { id: 'eng-writing-displays',name: 'Writing Displays', emoji: '✍️', sectionIds: ['writing-narrative','writing-narrative-prompts','writing-narrative-forest','writing-procedure','writing-procedure-2','writing-paragraph','writing-paragraph-2','writing-creative','writing-sentence','writing-informative','writing-informative-ocean','writing-informative-animals','writing-information-report','writing-persuasive','writing-poetry','writing-recount','literary-devices','book-review','writing-research-skills'] },
      ...
      { id: 'eng-comprehension',   name: 'Comprehension',    emoji: '📖', sectionIds: ['ws-comprehension-yr','ws-comprehension-yr2','ws-comprehension-ah','ws-comprehension-slang','ws-comprehension-mythical','ws-comprehension-text','ws-comprehension-text-2','ws-comprehension-text-3'] },
