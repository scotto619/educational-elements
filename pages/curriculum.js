...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    groups: [
      ...
      { id: 'eng-writing-displays',name: 'Writing Displays', emoji: '✍️', sectionIds: ['writing-narrative','writing-narrative-prompts','writing-narrative-forest','writing-narrative-gr6','writing-procedure','writing-procedure-2','writing-procedure-3','writing-procedure-gr6','writing-paragraph','writing-persuasive-2','writing-paragraph-2','writing-creative','writing-sentence','writing-informative','writing-informative-ocean','writing-informative-animals','writing-informative-gr6','writing-information-report','writing-persuasive','writing-persuasive-gr6','writing-poetry','writing-recount','literary-devices','book-review','writing-research-skills'] },
      ...
      { id: 'eng-comprehension',   name: 'Comprehension',    emoji: '📖', sectionIds: ['ws-comprehension-yr','ws-comprehension-yr2','ws-comprehension-ah','ws-comprehension-slang','ws-comprehension-mythical','ws-comprehension-text','ws-comprehension-text-2','ws-comprehension-text-3-lower','ws-comprehension-text-3','ws-comprehension-text-4','reading-inferencing-gr3'] },
...
const SECTION_CATEGORY_OVERRIDES = {
  english: {
    ...
    'Writing': ['writing-persuasive', 'writing-persuasive-2', 'writing-persuasive-gr6', 'writing-poetry', 'writing-recount', 'book-review', 'ws-writing'],
    'Reading & Comprehension': ['ws-comprehension-yr', 'ws-comprehension-yr2', 'ws-comprehension-ah', 'ws-comprehension-slang', 'reading-inferencing-gr3'],
