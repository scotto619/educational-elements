...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    groups: [
      ...
      { id: 'eng-writing-displays',name: 'Writing Displays', emoji: '✍️', sectionIds: ['writing-narrative','writing-narrative-forest','writing-procedure','writing-paragraph','writing-creative','writing-sentence','writing-informative','writing-informative-ocean','writing-informative-animals','writing-persuasive','writing-poetry','writing-recount','literary-devices','book-review','writing-research-skills'] },
      { id: 'eng-worksheets',      name: 'Worksheets',       emoji: '📄', sectionIds: ['ws-grammar','ws-writing','ws-writing-cute','ws-sentence-to-paragraphs','ws-writing-templates','ws-booklets','ws-story-builders'] },
      { id: 'eng-comprehension',   name: 'Comprehension',    emoji: '📖', sectionIds: ['ws-comprehension-yr','ws-comprehension-yr2','ws-comprehension-ah','ws-comprehension-slang','ws-comprehension-mythical','ws-comprehension-text'] },
  ...
  },
  {
    ...
    groups: [
      { id: 'decor-themes', name: 'Themes', emoji: '🎨', sectionIds: ['decor-beach','decor-cherry-blossom','decor-sweet-treats'] },
    ],
  },
];
