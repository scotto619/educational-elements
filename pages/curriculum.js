...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    groups: [
      ...
      { id: 'eng-worksheets',      name: 'Worksheets',       emoji: '📄', sectionIds: ['ws-grammar','ws-writing','ws-writing-cute','ws-sentence-to-paragraphs','ws-writing-templates','ws-booklets','ws-booklets-2','ws-story-builders'] },
