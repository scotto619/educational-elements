...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    groups: [
      ...
      { id: 'eng-worksheets',      name: 'Worksheets',       emoji: '📄', sectionIds: ['ws-grammar','ws-writing','ws-writing-cute','ws-sentence-to-paragraphs','ws-hypotheticals','ws-language-features-narratives','ws-writing-templates','ws-booklets','ws-booklets-2','ws-story-builders'] },
...
const SECTION_CATEGORY_OVERRIDES = {
  english: {
    ...
    'Writing': ['writing-persuasive', 'writing-persuasive-2', 'writing-persuasive-gr6', 'writing-persuasive-prompts', 'writing-poetry', 'writing-recount', 'writing-recount-gr1', 'book-review', 'ws-writing', 'ws-language-features-narratives'],
