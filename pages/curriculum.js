...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    groups: [
      ...
      { id: 'eng-worksheets',      name: 'Worksheets',       emoji: '📄', sectionIds: ['ws-grammar','ws-writing','ws-writing-cute','ws-writing-templates','ws-booklets','ws-story-builders'] },
  ...
  },
  {
    ...
    groups: [
      { id: 'decor-themes', name: 'Themes', emoji: '🎨', sectionIds: ['decor-beach','decor-cherry-blossom'] },
    ],
  },
];
