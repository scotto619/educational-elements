...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    sections: [
      ...
      { id: 'spelling-displays',name: 'Spelling',                  emoji: '🔡', bg: 'bg-emerald-100', border: 'border-emerald-300', hover: 'hover:bg-emerald-200', text: 'text-emerald-900', images: [{ name: 'Chunking', file: 'Spelling/Chunking.png' },{ name: 'Letter Sounds', file: 'Spelling/LetterSound.png' },{ name: 'Phonetic Strategies', file: 'Spelling/Phonetic Strategies.png' },{ name: 'Rhyming', file: 'Spelling/Rhyming.png' },{ name: 'Sound It Out', file: 'Spelling/SoundItOut.png' },{ name: 'Double the Final Consonant', file: 'Spelling/Spelling Rule Double the final consonant.png' },{ name: 'Drop the E', file: 'Spelling/Spelling Rule Drop the e.png' }] },
      { id: 'phonics-displays', name: 'Phonics Blends & Digraphs', emoji: '🔊', bg: 'bg-cyan-100',    border: 'border-cyan-300',    hover: 'hover:bg-cyan-200',    text: 'text-cyan-900',    images: [{ name: 'BL Blend', file: 'Phonics/BL.png' },{ name: 'BR Blend', file: 'Phonics/BR.png' },{ name: 'CH Digraph', file: 'Phonics/CH.png' },{ name: 'CL Blend', file: 'Phonics/CL.png' },{ name: 'CR Blend', file: 'Phonics/CR.png' },{ name: 'DR Blend', file: 'Phonics/DR.png' },{ name: 'FL Blend', file: 'Phonics/FL.png' },{ name: 'FR Blend', file: 'Phonics/FR.png' },{ name: 'GL Blend', file: 'Phonics/GL.png' },{ name: 'GR Blend', file: 'Phonics/GR.png' },{ name: 'PL Blend', file: 'Phonics/PL.png' },{ name: 'PR Blend', file: 'Phonics/PR.png' },{ name: 'SC Blend', file: 'Phonics/SC.png' },{ name: 'SH Digraph', file: 'Phonics/SH.png' },{ name: 'SK Blend', file: 'Phonics/SK.png' },{ name: 'SL Blend', file: 'Phonics/SL.png' },{ name: 'SM Blend', file: 'Phonics/SM.png' },{ name: 'SN Blend', file: 'Phonics/SN.png' },{ name: 'SP Blend', file: 'Phonics/SP.png' },{ name: 'ST Blend', file: 'Phonics/ST.png' },{ name: 'SW Blend', file: 'Phonics/SW.png' },{ name: 'TH Digraph', file: 'Phonics/TH.png' },{ name: 'TR Blend', file: 'Phonics/TR.png' },{ name: 'WH Digraph', file: 'Phonics/WH.png' }] },
      ...
      { id: 'writing-genres',   name: 'Writing Genres',            emoji: '✍️', bg: 'bg-pink-100',    border: 'border-pink-300',    hover: 'hover:bg-pink-200',    text: 'text-pink-900',    images: [{ name: 'Fantasy Narratives', file: 'Writing/Fantasy Narratives.png' },{ name: 'Information Reports', file: 'Writing/InfoReports.png' },{ name: 'Poetry', file: 'Writing/Poetry.png' },{ name: 'Recount Writing', file: 'Writing/Recount.png' },{ name: 'Science Fiction Narratives', file: 'Writing/SciFi Narratives.png' },{ name: 'Informative Writing', file: 'Writing/InformativeWritingDisplay.png' },{ name: 'TEEL Paragraph Structure', file: 'Writing/TEELParagraphDisplay.png' },{ name: 'Narrative Writing Display', file: 'Writing/NarrativeWritingDisplay.png' },{ name: 'Informative Writing Structure', file: 'Writing/Informative Writing Structure.png' },{ name: 'Narrative Writing Structure', file: 'Writing/Narrative Writing Structure.png' },{ name: 'Poetry Writing Structure', file: 'Writing/Poetry Writing Structure.png' },{ name: 'Retell Writing Structure', file: 'Writing/Retell Writing Structure.png' }] },
  ...
  },
  {
    ...
    sections: [
      { id: 'behaviour-cues', name: 'Behaviour Cues', emoji: '🎨', bg: 'bg-rose-100', border: 'border-rose-300', hover: 'hover:bg-rose-200', text: 'text-rose-900', images: [{ name: 'Blue', file: 'Blue.png' },{ name: 'Colours', file: 'Colours.png' },{ name: 'Green', file: 'Green.png' },{ name: 'Red', file: 'Red.png' },{ name: 'Yellow', file: 'Yellow.png' },{ name: 'Zones of Regulation', file: 'Zones of Regulation.png' },{ name: 'Zones of Regulation - Blue', file: 'Zones of Regulation Blue.png' },{ name: 'Zones of Regulation - Green', file: 'Zones of Regulation Green.png' },{ name: 'Zones of Regulation - Red', file: 'Zones of Regulation Red.png' },{ name: 'Zones of Regulation - Yellow', file: 'Zones of Regulation Yellow.png' }] },
    ],
  },
  {
