...
const ALL_DISPLAY_CATEGORIES = [
  {
    ...
    groups: [
      ...
      { id: 'eng-comprehension',   name: 'Comprehension',    emoji: '📖', sectionIds: ['ws-comprehension-yr','ws-comprehension-yr2','ws-comprehension-ah','ws-comprehension-slang','ws-comprehension-mythical','ws-comprehension-text','ws-comprehension-text-2','ws-comprehension-text-3-lower','ws-comprehension-text-3','ws-comprehension-text-4','reading-inferencing-gr3','reading-strategies-my'] },
...
const SECTION_CATEGORY_OVERRIDES = {
  english: {
    ...
    'Writing': ['writing-persuasive', 'writing-persuasive-2', 'writing-persuasive-gr6', 'writing-persuasive-prompts', 'writing-poetry', 'writing-recount', 'writing-recount-gr1', 'book-review', 'ws-writing'],
    'Reading & Comprehension': ['ws-comprehension-yr', 'ws-comprehension-yr2', 'ws-comprehension-ah', 'ws-comprehension-slang', 'reading-inferencing-gr3', 'reading-strategies-my'],
