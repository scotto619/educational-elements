...
export const SHOP_BASIC_AVATARS = [
  ...
  { name: 'Psychic Kid', price: 18, path: '/shop/Basic/Update1/Eleven.png' },
  ...
  { name: 'Chrome Enforcer', price: 30, path: '/shop/Basic/Update1/Terminator.png' },
  { name: '67', price: 24, path: '/shop/Basic/Update2/67.png' },
  { name: 'Sky Bomber', price: 26, path: '/shop/Basic/Update2/Bombardiro.png' },
  { name: 'Grand Luchador', price: 22, path: '/shop/Basic/Update2/Lucho.png' },
  { name: 'Phoenix', price: 28, path: '/shop/Basic/Update2/Phoenix.png' },
  { name: 'Rugby', price: 20, path: '/shop/Basic/Update2/Rugby.png' },
  { name: 'Steel Titan', price: 30, path: '/shop/Basic/Update2/T800.png' },
  { name: 'Sneaker Shark', price: 25, path: '/shop/Basic/Update2/Tralalero.png' },
  { name: 'Espresso Ninja', price: 18, path: '/shop/Basic/Update2/Cappuccino.png' },
  { name: 'Rose Scholar', price: 22, path: '/shop/Basic/Update3/Belle.png' },
  { name: 'Heavyweight Champ', price: 28, path: '/shop/Basic/Update3/Cena.png' },
  { name: 'Chicken Banana', price: 15, path: '/shop/Basic/Update3/ChickenBanana.png' },
  { name: 'Armored Ranger', price: 25, path: '/shop/Basic/Update3/Chief.png' },
  { name: 'Hero Student', price: 30, path: '/shop/Basic/Update3/Deku.png' },
  { name: 'Ice Queen', price: 24, path: '/shop/Basic/Update3/Elsa.png' },
  { name: 'Halfling Hero', price: 22, path: '/shop/Basic/Update3/Frodo.png' },
  { name: 'Ki Warrior', price: 35, path: '/shop/Basic/Update3/Goku.png' },
  { name: 'Spell Student', price: 28, path: '/shop/Basic/Update3/Harry.png' },
  { name: 'Mega Bruiser', price: 35, path: '/shop/Basic/Update3/Hulk.png' },
  { name: 'Hunter', price: 20, path: '/shop/Basic/Update3/Hunter.png' },
  { name: 'Masked Sensei', price: 30, path: '/shop/Basic/Update3/Kakashi.png' },
  { name: 'Elf Swordsman', price: 28, path: '/shop/Basic/Update3/Link.png' },
  { name: 'Pipe Runner', price: 30, path: '/shop/Basic/Update3/Mario.png' },
  { name: 'Ninja Spirit', price: 30, path: '/shop/Basic/Update3/Naruto.png' },
  { name: 'Shadow Ninja', price: 30, path: '/shop/Basic/Update3/Saske.png' },
  { name: 'Blue Speedster', price: 28, path: '/shop/Basic/Update3/Sonic.png' },
  { name: 'Time Swordsman', price: 32, path: '/shop/Basic/Update3/Trunks.png' },
  { name: 'Battle Prince', price: 35, path: '/shop/Basic/Update3/Vegeta.png' },
  { name: 'Gloom Girl', price: 22, path: '/shop/Basic/Update3/Wednesday.png' },
  { name: 'Green Dino', price: 26, path: '/shop/Basic/Update3/Yoshi.png' },
...
export const HALLOWEEN_BASIC_AVATARS = [
  ...
  { name: 'Masked Camper', price: 18, path: '/shop/Themed/Halloween/Basic/Jason.png', theme: 'halloween' },
  { name: 'Pumpkin Monarch', price: 20, path: '/shop/Themed/Halloween/Basic/PumpkinKing.png', theme: 'halloween' },
...
export const SHOP_BASIC_PETS = [
  { name: 'Bubblebrew', price: 25, path: '/shop/BasicPets/Alchemist.png' },
  { name: 'Roughtusk', price: 30, path: '/shop/BasicPets/Barbarian.png' },
  { name: 'Lutelet', price: 25, path: '/shop/BasicPets/Bard.png' },
  { name: 'Packleader', price: 35, path: '/shop/BasicPets/Beastmaster.png' },
  { name: 'Lightling', price: 25, path: '/shop/BasicPets/Cleric.png' },
  { name: 'Prism Squire', price: 45, path: '/shop/BasicPets/Crystal Knight.png' },
  { name: 'Prism Oracle', price: 45, path: '/shop/BasicPets/Crystal Sage.png' },
  { name: 'Fernwing', price: 50, path: '/shop/BasicPets/DragonPet.png' },
  { name: 'Dozer', price: 40, path: '/shop/BasicPets/Dream.png' },
  { name: 'Thornpaw', price: 35, path: '/shop/BasicPets/Druid.png' },
  { name: 'Wrenchy', price: 30, path: '/shop/BasicPets/Engineer.png' },
  { name: 'Trufflesnout', price: 20, path: '/shop/BasicPets/FarmPet1.png' },
  { name: 'Old Shepherd', price: 20, path: '/shop/BasicPets/FarmPet2.png' },
  { name: 'Harvest Mouse', price: 20, path: '/shop/BasicPets/FarmPet3.png' },
  { name: 'Frostwhisker', price: 35, path: '/shop/BasicPets/Frost Mage.png' },
  { name: 'Snaggle', price: 25, path: '/shop/BasicPets/GoblinPet.png' },
  { name: 'Trickletuft', price: 40, path: '/shop/BasicPets/Illusionist.png' },
  { name: 'Sir Pipsqueak', price: 30, path: '/shop/BasicPets/Knight.png' },
  { name: 'Voltling', price: 50, path: '/shop/BasicPets/Lightning.png' },
  { name: 'Pebblepaws', price: 25, path: '/shop/BasicPets/Monk.png' },
  { name: 'Gravemite', price: 40, path: '/shop/BasicPets/Necromancer.png' },
  { name: 'Tuskling', price: 30, path: '/shop/BasicPets/Orc.png' },
  { name: 'Oathpup', price: 35, path: '/shop/BasicPets/Paladin.png' },
  { name: 'Squawks', price: 25, path: '/shop/BasicPets/PiratePet1.png' },
  { name: 'First Mate', price: 25, path: '/shop/BasicPets/PiratePet2.png' },
  { name: 'Snapjaw', price: 25, path: '/shop/BasicPets/PiratePet3.png' },
  { name: 'Burrow', price: 20, path: '/shop/BasicPets/RabbitPet.png' },
  { name: 'Boltbuddy', price: 30, path: '/shop/BasicPets/RobotBoyPet.png' },
  { name: 'Gigglegear', price: 30, path: '/shop/BasicPets/RobotGirlPet.png' },
  { name: 'Gearhound', price: 30, path: '/shop/BasicPets/RobotPet1.png' },
  { name: 'Botling', price: 30, path: '/shop/BasicPets/RobotPet2.png' },
  { name: 'Sneakwhisker', price: 25, path: '/shop/BasicPets/Rogue.png' },
  { name: 'Kickle', price: 20, path: '/shop/BasicPets/SoccerPet.png' },
  { name: 'Shadowpaw', price: 35, path: '/shop/BasicPets/Stealth.png' },
  { name: 'Ticktock Knight', price: 50, path: '/shop/BasicPets/Time Knight.png' },
  { name: 'Prismane', price: 35, path: '/shop/BasicPets/UnicornPet.png' },
  { name: 'Battlepup', price: 30, path: '/shop/BasicPets/Warrior.png' },
  { name: 'Sparklewand', price: 25, path: '/shop/BasicPets/Wizard.png' },
  { name: 'Skink Squire', price: 28, path: '/shop/BasicPets/Update1/LizardPet.png' },
  { name: 'Inkwell', price: 32, path: '/shop/BasicPets/Update1/OctopusPet.png' },
  { name: 'Rusty', price: 34, path: '/shop/BasicPets/Update1/RedpandaPet.png' },
  { name: 'Shark Buddy', price: 33, path: '/shop/Basic/Update1/SharkPet.png' },
  { name: 'Zephyr Wisp', price: 35, path: '/shop/BasicPets/Update2/Air.png' },
  { name: 'Peep', price: 22, path: '/shop/BasicPets/Update2/Choco.png' },
  { name: 'Terrasprout', price: 35, path: '/shop/BasicPets/Update2/Earth.png' },
  { name: 'Cinderling', price: 38, path: '/shop/BasicPets/Update2/Fire.png' },
  { name: 'Coralfin', price: 25, path: '/shop/BasicPets/Update2/Nemo.png' },
  { name: 'Patch', price: 28, path: '/shop/BasicPets/Update2/Snoopy.png' },
  { name: 'Emberfox', price: 30, path: '/shop/BasicPets/Update2/Tails.png' },
  { name: 'Tidesoul', price: 35, path: '/shop/BasicPets/Update2/Water.png' },
  { name: 'Scrapbot', price: 30, path: '/shop/BasicPets/Update 3/Claptrap.png' },
  { name: 'Mischief', price: 25, path: '/shop/BasicPets/Update 3/Monkey.png' },
  { name: 'Wafflebeast', price: 20, path: '/shop/BasicPets/Update 3/Waffle.png' },
  // ── New Pets wave ──────────────────────────────────────────────────────────
  ...
  { name: 'Lottie', price: 25, path: '/shop/New Pets/w.png' },
  { name: 'Crimson Drake', price: 60, path: '/shop/New Pets/x.png' },
  { name: 'Sporeling', price: 24, path: '/shop/New Pets/y.png' },
  { name: 'Golden Gryphlet', price: 60, path: '/shop/New Pets/z.png' }
];

export const SHOP_PREMIUM_PETS = [
  { name: 'Astral Lion', price: 60, path: '/shop/PremiumPets/LionPet.png' },
  { name: 'Solserpent', price: 50, path: '/shop/PremiumPets/SnakePet.png' },
  { name: 'Duskwing', price: 50, path: '/shop/PremiumPets/VampirePet.png' }
];

// ===============================================
// LEGACY ITEM RENAMES — old display names → new original names.
// Existing student saves keep the OLD names (avatarBase, ownedAvatars,
// ownedPets), so every lookup resolves through this map. NEVER remove
// entries: they are what keeps old saves rendering correctly.
// ===============================================
export const LEGACY_ITEM_RENAMES = {
  // Avatars
  'Eleven': 'Psychic Kid',
  'Terminator': 'Chrome Enforcer',
  'T800': 'Steel Titan',
  'Bombardiro': 'Sky Bomber',
  'Tralalero': 'Sneaker Shark',
  'Lucho': 'Grand Luchador',
  'Cappuccino': 'Espresso Ninja',
  'Belle': 'Rose Scholar',
  'Cena': 'Heavyweight Champ',
  'Chief': 'Armored Ranger',
  'Deku': 'Hero Student',
  'Elsa': 'Ice Queen',
  'Frodo': 'Halfling Hero',
  'Goku': 'Ki Warrior',
  'Harry': 'Spell Student',
  'Hulk': 'Mega Bruiser',
  'Kakashi': 'Masked Sensei',
  'Link': 'Elf Swordsman',
  'Mario': 'Pipe Runner',
  'Naruto': 'Ninja Spirit',
  'Sasuke': 'Shadow Ninja',
  'Sonic': 'Blue Speedster',
  'Trunks': 'Time Swordsman',
  'Vegeta': 'Battle Prince',
  'Wednesday': 'Gloom Girl',
  'Yoshi': 'Green Dino',
  'Jason': 'Masked Camper',
  'PumpkinKing': 'Pumpkin Monarch',
  // Pets — shared art with Champion's Menagerie keeps the Menagerie name
  'Monkey': 'Mischief',
  'Choco Pup': 'Peep',
  'Snoopy': 'Patch',
  'Nemo': 'Coralfin',
  ...
  'Tails': 'Emberfox',
  'Red Panda Pal': 'Rusty',
  'Farm Pet 1': 'Trufflesnout',
  'Farm Pet 2': 'Old Shepherd',
  'Farm Pet 3': 'Harvest Mouse',
  'Pirate Pet 1': 'Squawks',
  'Pirate Pet 2': 'First Mate',
  'Pirate Pet 3': 'Snapjaw',
  'Goblin Pet': 'Snaggle',
  'Lizard Hatchling': 'Skink Squire',
  'Octopus Buddy': 'Inkwell',
  'Robot Pet 1': 'Gearhound',
  'Robot Pet 2': 'Botling',
  'Claptrap': 'Scrapbot',
  'Soccer Pet': 'Kickle',
  'Waffle': 'Wafflebeast',
  'Air Spirit': 'Zephyr Wisp',
  'Water Spirit': 'Tidesoul',
  'Fire Spirit': 'Cinderling',
  'Earth Spirit': 'Terrasprout',
  'Unicorn Pet': 'Prismane',
  'Dragon Pet': 'Fernwing',
  'Snake Pet': 'Solserpent',
  'Vampire Pet': 'Duskwing',
  'Lion Pet': 'Astral Lion',
  // Pets — fresh original names
  'Alchemist Pet': 'Bubblebrew',
  'Barbarian Pet': 'Roughtusk',
  'Bard Pet': 'Lutelet',
  'Beastmaster Pet': 'Packleader',
  'Cleric Pet': 'Lightling',
  'Crystal Knight Pet': 'Prism Squire',
  'Crystal Sage Pet': 'Prism Oracle',
  'Dream Pet': 'Dozer',
  'Druid Pet': 'Thornpaw',
  'Engineer Pet': 'Wrenchy',
  'Frost Mage Pet': 'Frostwhisker',
  'Illusionist Pet': 'Trickletuft',
  'Knight Pet': 'Sir Pipsqueak',
  'Lightning Pet': 'Voltling',
  'Monk Pet': 'Pebblepaws',
  'Necromancer Pet': 'Gravemite',
  'Orc Pet': 'Tuskling',
  'Paladin Pet': 'Oathpup',
  'Robot Boy Pet': 'Boltbuddy',
  'Robot Girl Pet': 'Gigglegear',
  'Rogue Pet': 'Sneakwhisker',
  'Stealth Pet': 'Shadowpaw',
  'Time Knight Pet': 'Ticktock Knight',
  'Warrior Pet': 'Battlepup',
  'Wizard Pet': 'Sparklewand',
  'Lottie the Axolotl': 'Lottie',
  'Mushroom Buddy': 'Sporeling',
};
const LEGACY_KEY_MAP = Object.fromEntries(
  Object.entries(LEGACY_ITEM_RENAMES).map(([oldName, newName]) => [normalizeItemKey(oldName), newName])
);
// Resolve a possibly-old saved name to its current display name
export const resolveItemName = (name) => LEGACY_KEY_MAP[normalizeItemKey(name)] || name;
// Compare item names across the rename (old saved name vs new shop name)
export const isSameItemName = (a, b) => normalizeItemKey(resolveItemName(a)) === normalizeItemKey(resolveItemName(b));

// ===============================================
// AVATAR IMAGE PATHS - UPDATED WITH SEASONAL COLLECTIONS
// ===============================================
export const getAvatarImage = (avatarBase, level) => {
  const targetKey = normalizeItemKey(resolveItemName(avatarBase));
...
export const getPetImage = (pet) => {
  ...
  const normalizedNameKey = normalizeItemKey(resolveItemName(pet.name));
